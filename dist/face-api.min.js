! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = t || self).faceapi = t.faceapi || {}) }(this, function(c) {
    ...
    function Wo(t, e, n, r, o, i, a, s) {
        void 0 === s && (s = !1);
        for (var u = Array.from(e).map(function(t, e) { return { score: t, boxIndex: e, suppressBeginIndex: 0 } }).filter(function(t) { return t.score > o }).sort(Uo), c = 0 < i ? -.5 / i : 0, l = [], h = []; l.length < n && 0 < u.length;) {
            var f = u.pop(),
                p = f.score,
                d = f.boxIndex,
                v = f.suppressBeginIndex;
            if (p < o) break;
            for (var m = !1, g = l.length - 1; v <= g; --g) { var y = zo(t, d, l[g]); if (r <= y) { m = !0; break } if (f.score = f.score * (E = r, _ = c, I = y, void 0, R = Math.exp(_ * I * I), I <= E ? R : 0), f.score <= o) break }
            ...
            c = t.map(function(t) {
                return function(t, e, n) {
                            ...
                            case 2:
                                return function(t) {
                                    ...
                                    var s = T(e),
                                        ...
                                        c = s.keptDims,
                                        l = u;
                                    if (l.length < e.length) { var h = ii(t, l); return "\n      " + y(h) + "\n      float " + r + "(int row, int col) {\n        return " + r + "(" + ai(["row", "col"], c) + ");\n      }\n    " }
                            ...
                            case 3:
                                return function(t) {
                                    var e = t.shapeInfo.logicalShape,
                                        ...
                                        u = a.keptDims,
                                        c = s;
                                    if (c.length < e.length) { var l = ii(t, c); return "\n        " + y(l) + "\n        float " + r + "(int row, int col, int depth) {\n          return " + r + "(" + ai(["row", "col", "depth"], u) + ");\n        }\n      " }
                    ...
                    return o.length <= i.length && (r += n ? function(t, e) {
                        ...
                        var f;
                        f = s < 2 && 0 < a ? "coords" : t.shapeInfo.logicalShape.map(function(t, e) { return "coords." + h[e + l] }).join(", ");
                        ...
                        if (1 !== a || d || v) {
                            if (d && !v) p = 1 === s ? "\n        return vec4(outputValue.x, outputValue.x, 0., 0.);\n      " : "\n        return vec4(outputValue.x);\n      ";
                                ...
                                var m = a - 2,
                                    g = a - 1; - 1 < u.indexOf(m) && -1 < u.indexOf(g) ? p = "return vec4(outputValue.x);" : -1 < u.indexOf(m) ? p = "return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);" : -1 < u.indexOf(g) && (p = "return vec4(outputValue.xx, outputValue.zz);")
                            }
    ...
    function mi(t) {
        this.outputShape = [], this.outputShape = bn(t, 1), this.variableNames = t.map(function(t, e) { return "T" + e });
    ...
    function Bi(t, e, n, r) {
        ...
        for (var o = t.inHeight, i = t.inWidth, a = t.padInfo.top, s = t.padInfo.left, u = t.strideHeight, c = t.strideWidth, l = t.dilationHeight, h = t.dilationWidth, f = t.filterHeight, p = t.filterWidth, d = p, v = "int xR; int xC; int xCOffset;", m = 0; m < f; m++)
        ...
        for (m = 0; m < f; m++)
            for (g = 0; g < p; g++) v += "dotProd += xR" + m + "C" + g + " * wR" + m + "C" + g + ";";
        var b = "",
            w = "";
    ...
    function pa(t, e, n, r, o) {
        ...
        le(t, e, function() { return t.bindBuffer(t.PIXEL_PACK_BUFFER, i) });
        var a = 16 * n * r;
        return le(t, e, function() { return t.bufferData(t.PIXEL_PACK_BUFFER, a, t.STREAM_READ) }), le(t, e, function() { return t.readPixels(0, 0, r, n, t.RGBA, t.FLOAT, 0) }), le(t, e, function() { return t.bindBuffer(t.PIXEL_PACK_BUFFER, null) }), i
    }
    ...
    function va(t, e, n, r, o) {
        ...
        return le(t, e, function() { return t.readPixels(0, 0, a, s, o.downloadTextureFormat, t.UNSIGNED_BYTE, u) }), new Float32Array(u.buffer)
    }
    ...
    function ga(t, e, n, r) { var o = new Float32Array(n * r * 4); return le(t, e, function() { return t.readPixels(0, 0, r, n, t.RGBA, t.FLOAT, o) }), o }
    var ya = Object.freeze({ createVertexShader: ea, createVertexBuffer: na, createIndexBuffer: ra, createFloat32MatrixTexture: ia, createFloat16MatrixTexture: aa, createUnsignedBytesMatrixTexture: sa, createPackedMatrixTexture: ua, createFloat16PackedMatrixTexture: ca, bindVertexProgramAttributeStreams: la, uploadDenseMatrixToTexture: ha, uploadPixelDataToTexture: fa, createBufferFromOutputTexture: pa, downloadFloat32MatrixFromBuffer: da, downloadByteEncodedFloatMatrixFromOutputTexture: va, downloadPackedMatrixFromBuffer: ma, downloadMatrixFromPackedOutputTexture: ga }),
        xa = (Object.defineProperty(ba.prototype, "debug", { get: function() { return _().getBool("DEBUG") }, enumerable: !0, configurable: !0 }), ba.prototype.dispose = function() {
            var t = this;
            if (!this.disposed) {
        ...
        }, ba.prototype.downloadMatrixFromPackedTexture = function(t, e, n) { var r = this; return this.downloadMatrixDriver(t, function() { return ga(r.gl, r.debug, e, n) }) }, ba.prototype.createProgram = function(t) {
            this.throwIfDisposed();
            var e = this.gl,
                n = ve(e, this.debug, t),
                r = ea(e, this.debug),
                o = xe(e, this.debug);
            return le(e, this.debug, function() { return e.attachShader(o, r) }), le(e, this.debug, function() { return e.attachShader(o, n) }), be(e, this.debug, o), this.debug && we(e, this.debug, o), this.vertexAttrsAreBound || (this.setProgram(o), this.vertexAttrsAreBound = la(e, this.debug, this.program, this.vertexBuffer)), o
        }, ba.prototype.deleteProgram = function(t) {
            var e = this;
            this.throwIfDisposed(), t === this.program && (this.program = null), null != t && le(this.gl, this.debug, function() { return e.gl.deleteProgram(t) })
        }, ba.prototype.setProgram = function(t) {
            var e = this;
            this.throwIfDisposed(), this.program = t, null != this.program && this.debug && we(this.gl, this.debug, this.program), le(this.gl, this.debug, function() { return e.gl.useProgram(t) })
        }, ba.prototype.getUniformLocation = function(t, e, n) { return void 0 === n && (n = !0), this.throwIfDisposed(), n ? De(this.gl, this.debug, t, e) : Ae(this.gl, t, e) }, ba.prototype.getAttributeLocation = function(t, e) { var n = this; return this.throwIfDisposed(), le(this.gl, this.debug, function() { return n.gl.getAttribLocation(t, e) }) }, ba.prototype.getUniformLocationNoThrow = function(t, e) { return this.throwIfDisposed(), this.gl.getUniformLocation(t, e) }, ba.prototype.setInputMatrixTexture = function(t, e, n) { this.throwIfDisposed(), this.throwIfNoProgram(), Te(this.gl, this.debug, this.program, t, e, n) }, ba.prototype.setOutputMatrixTexture = function(t, e, n) { this.setOutputMatrixTextureDriver(t, n, e) }, ba.prototype.setOutputPackedMatrixTexture = function(t, e, n) {
            this.throwIfDisposed();
            var r = ue(e, n),
                o = r[0],
                i = r[1];
            this.setOutputMatrixTextureDriver(t, o, i)
        }, ba.prototype.setOutputMatrixWriteRegion = function(t, e, n, r) { this.setOutputMatrixWriteRegionDriver(n, t, r, e) }, ba.prototype.setOutputPackedMatrixWriteRegion = function(t, e, n, r) { throw new Error("setOutputPackedMatrixWriteRegion not implemented.") }, ba.prototype.debugValidate = function() { null != this.program && we(this.gl, this.debug, this.program), Me(this.gl) }, ba.prototype.executeProgram = function() {
            this.throwIfDisposed(), this.throwIfNoProgram();
            var t = this.gl;
            this.debug && this.debugValidate(), le(t, this.debug, function() { return t.drawElements(t.TRIANGLES, 6, t.UNSIGNED_SHORT, 0) })
        }, ba.prototype.blockUntilAllProgramsCompleted = function() {
            var t = this;
            this.throwIfDisposed(), le(this.gl, this.debug, function() { return t.gl.finish() })
        }, ba.prototype.getQueryTimerExtension = function() { return null == this.disjointQueryTimerExtension && (this.disjointQueryTimerExtension = pe(this.gl, this.debug, 2 === _().getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION") ? "EXT_disjoint_timer_query_webgl2" : "EXT_disjoint_timer_query")), this.disjointQueryTimerExtension }, ba.prototype.getQueryTimerExtensionWebGL2 = function() { return this.getQueryTimerExtension() }, ba.prototype.getQueryTimerExtensionWebGL1 = function() { return this.getQueryTimerExtension() }, ba.prototype.beginQuery = function() {
        ...
        }, ba.prototype.getQueryTime = function(t, e) { if (0 === e) return null; if (2 === e) { var n = this.gl; return n.getQueryParameter(t, n.QUERY_RESULT) / 1e6 } var r = this.getQueryTimerExtensionWebGL1(); return r.getQueryObjectEXT(t, r.QUERY_RESULT_EXT) / 1e6 }, ba.prototype.isQueryAvailable = function(t, e) {
            if (0 === e) return !0;
        ...
        }, ba.prototype.pollFence = function(e) { var n = this; return new Promise(function(t) { n.addItemToPoll(function() { return e.isFencePassed() }, function() { return t() }) }) }, ba.prototype.pollItems = function() {
        ...
        }, ba.prototype.bindTextureToFrameBuffer = function(t) { this.throwIfDisposed(), Ne(this.gl, this.debug, t, this.framebuffer), this.debug && Me(this.gl) }, ba.prototype.unbindTextureToFrameBuffer = function() { null != this.outputTexture ? (Ne(this.gl, this.debug, this.outputTexture, this.framebuffer), this.debug && Me(this.gl)) : Fe(this.gl, this.debug, this.framebuffer) }, ba.prototype.downloadMatrixDriver = function(t, e) { this.bindTextureToFrameBuffer(t); var n = e(); return this.unbindTextureToFrameBuffer(), n }, ba.prototype.setOutputMatrixTextureDriver = function(t, e, n) {
            this.throwIfDisposed();
            var r = this.gl;
            Ne(r, this.debug, t, this.framebuffer), this.debug && Me(r), this.outputTexture = t, le(r, this.debug, function() { return r.viewport(0, 0, e, n) }), le(r, this.debug, function() { return r.scissor(0, 0, e, n) })
        }, ba.prototype.setOutputMatrixWriteRegionDriver = function(t, e, n, r) {
            var o = this;
            this.throwIfDisposed(), le(this.gl, this.debug, function() { return o.gl.scissor(t, e, n, r) })
        }, ba.prototype.throwIfDisposed = function() { if (this.disposed) throw new Error("Attempted to use disposed GPGPUContext.") }, ba.prototype.throwIfNoProgram = function() { if (null == this.program) throw new Error("No GPU program is currently set.") }, ba);
    ...
    function Ca(t, e, n) {
        ...
        for (var r = n.filterWidth, o = n.inChannels, i = n.strideWidth, a = n.strideHeight, s = n.padInfo, u = n.outWidth, c = n.dilationWidth, l = n.dilationHeight, h = n.dataFormat, f = s.left, p = s.top, d = o * r, v = Jo(), m = "channelsLast" === h, g = m ? 0 : 1, y = m ? 1 : 2, x = "", b = 0; b <= 1; b++)
    ...
    function Ma(n, t, e) {
        ...
        for (var r = n.length, o = oi(r), i = t.map(function(t) { return t[0] }).join(","), a = t.map(function(t, e) { return t[0] + n[e] }).join(","), s = $o("rc", r), u = $o("source", r), c = s[r - 1] + " < " + this.outputShape[r - 1], l = 1 === r ? "source" : "vec2(" + u.slice(-2).join() + ")", h = [o + " rc = outputLoc;", s[r - 1] + " += 1;\n       if(" + c + ") {\n      ", 1 === r ? "" : "}\n       rc = outputLoc;\n       " + s[r - 2] + " += 1;\n       if(" + s[r - 2] + " < " + this.outputShape[r - 2] + ") {", 1 === r ? "" : "  " + s[r - 1] + " += 1;\n         if(" + c + ") {"], f = 1 === r ? "rc < start || rc >= end" : "any(lessThan(rc, start)) || any(greaterThanEqual(rc, end))", p = "", d = 0, v = 1 === r ? 2 : 4; d < v; d++) p += "\n        " + h[d] + "\n        if (" + f + ") {\n          result[" + d + "] = float(" + e + ");\n        } else {\n          " + o + " source = rc - start;\n          result[" + d + "] = getChannel(getX(" + u.join() + "), " + l + ");\n        }\n      ";
    ...
    var Za = (ns.prototype.getCustomSetupFunc = function(n) { var r = this; if (n.length !== this.rank) throw Error("The rank (" + this.rank + ") of the program must match the length of start (" + n.length + ")"); return function(t, e) { null == r.startLoc && (r.startLoc = t.getUniformLocationNoThrow(e, "start"), null == r.startLoc) || t.gl.uniform1iv(r.startLoc, n) } }, ns),
        ts = (es.prototype.acquireTexture = function(t, e, n) {
            var r, o = rs(e, n),
                i = os(t, o, n);
        ...
        }, es.prototype.getNumUsedTextures = function() { return this.numUsedTextures }, es.prototype.getNumFreeTextures = function() { return this.numFreeTextures }, es.prototype.dispose = function() {
            var e = this;
            if (null != this.freeTextures) {
    ...
    function Ss(t, e) { if (void 0 === e && (e = !1), "linear" === t) return "return x;"; if ("relu" === t) return e ? _s : vs; if ("elu" === t) return e ? Rs : gs; if ("relu6" === t) return e ? Is : ms; if ("prelu" === t) return e ? Ci : wi; throw new Error("Activation " + t + " has not been implemented for the WebGL backend.") }
    var Ds, As = (t(Ts, Ds = lo), Ts.prototype.numDataIds = function() { return this.texData.numDataIds() + (this.cpuBackend ? this.cpuBackend.numDataIds() : 0) - this.pendingDeletes }, Ts.prototype.write = function(t, e, n) { if (_().getBool("DEBUG") && this.checkNumericalProblems(t), "complex64" === n && null != t) throw new Error("Cannot write to a complex64 dtype. Please use tf.complex(real, imag)."); var r = {}; return this.texData.set(r, { shape: e, dtype: n, values: t, usage: Jt.UPLOAD }), r }, Ts.prototype.move = function(t, e, n, r) {
        ...
        return y(this, void 0, void 0, function() {
            ...
            return R(this, function(t) {
                switch (t.label) {
                    ...
                    case 5:
                        return null != p && this.disposeData(p.dataId), b = this.convertAndCacheOnCPU(E, v), w = this.pendingRead.get(E), this.pendingRead.delete(E), w.forEach(function(t) { return t(b) }), this.pendingDisposal.has(E) && (this.pendingDisposal.delete(E), this.disposeData(E), this.pendingDeletes--), [2, b]
                }
            })
        })
    }, Ts.prototype.checkNumericalProblems = function(t) {
        if (null != t)
            for (var e = 0; e < t.length; e++) { var n = t[e]; if (!he(n)) { if (_().getBool("WEBGL_RENDER_FLOAT32_CAPABLE")) throw Error("The value " + n + " cannot be represented with your current settings. Consider enabling float32 rendering: 'tf.env().set('WEBGL_RENDER_FLOAT32_ENABLED', true);'"); throw Error("The value " + n + " cannot be represented on this device.") } }
        ...
        if (_().getBool("WEBGL_PACK_ARRAY_OPERATIONS") && 1 < t[0].rank) { var s = new gi(t.map(function(t) { return t.shape }), e); return this.compileAndRun(s, t) }
        var u = bn(t.map(function(t) { return t.shape }), e),
    ...
    }, Ts.prototype.neg = function(t) { if (this.shouldExecuteOnCPU([t])) return this.cpuBackend.neg(t); if (_().getBool("WEBGL_PACK_UNARY_OPERATIONS")) return this.packedUnaryOp(t, ys, t.dtype); var e = new us(t.shape, ys); return this.compileAndRun(e, [t]) }, Ts.prototype.batchMatMul = function(t, e, n, r) {
    ...
    }, Ts.prototype.minimum = function(t, e) { if (this.shouldExecuteOnCPU([t, e])) return this.cpuBackend.minimum(t, e); var n = _().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new di("\n  vec4 result = vec4(min(a, b));\n  vec4 isNaN = min(vec4(isnan(a)) + vec4(isnan(b)), vec4(1.0));\n  \n  result.r = isNaN.r > 0. ? NAN : result.r;\n  result.g = isNaN.g > 0. ? NAN : result.g;\n  result.b = isNaN.b > 0. ? NAN : result.b;\n  result.a = isNaN.a > 0. ? NAN : result.a;\n\n  return result;\n", t.shape, e.shape) : new pi("\n  if (isnan(a)) return a;\n  if (isnan(b)) return b;\n\n  return min(a, b);\n", t.shape, e.shape); return this.compileAndRun(n, [t, e]) }, Ts.prototype.mod = function(t, e) { var n = _().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new di("\n  vec4 result = mod(a, b);\n  vec4 isNaN = vec4(equal(b, vec4(0.0)));\n  \n  result.r = isNaN.r > 0. ? NAN : result.r;\n  result.g = isNaN.g > 0. ? NAN : result.g;\n  result.b = isNaN.b > 0. ? NAN : result.b;\n  result.a = isNaN.a > 0. ? NAN : result.a;\n\n  return result;\n", t.shape, e.shape) : new pi("if (b == 0.0) return NAN;\n  return mod(a, b);", t.shape, e.shape); return this.compileAndRun(n, [t, e]) }, Ts.prototype.max = function(t, e) {
    ...
    }, Ts.prototype.maximum = function(t, e) { if (this.shouldExecuteOnCPU([t, e])) return this.cpuBackend.maximum(t, e); var n = _().getBool("WEBGL_PACK_BINARY_OPERATIONS") ? new di("\n  vec4 result = vec4(max(a, b));\n  vec4 isNaN = min(vec4(isnan(a)) + vec4(isnan(b)), vec4(1.0));\n  \n  result.r = isNaN.r > 0. ? NAN : result.r;\n  result.g = isNaN.g > 0. ? NAN : result.g;\n  result.b = isNaN.b > 0. ? NAN : result.b;\n  result.a = isNaN.a > 0. ? NAN : result.a;\n\n  return result;\n", t.shape, e.shape) : new pi("\n  if (isnan(a)) return a;\n  if (isnan(b)) return b;\n\n  return max(a, b);\n", t.shape, e.shape); return this.compileAndRun(n, [t, e]) }, Ts.prototype.all = function(t, e) {
        vn("all", e, t.rank);
        var n = pn(t.shape, e),
            r = n[0],
            o = L(n[1]),
        ...
        var c = this,
            ...
            i = this.complex(r, o);
        return r.dispose(), o.dispose(), i
    }, Ts.prototype.makeComplexComponentTensorInfo = function(t, e) { return { dataId: e.dataId, dtype: e.dtype, shape: t.shape } }, Ts.prototype.addN = function(t) {
        if (1 === t.length) return t[0];
        ...
        var o = t.map(function(t) { return t.dtype }).reduce(function(t, e) { return Pt(t, e) }),
    ...
    }, Ts.prototype.subtract = function(t, e) { if ("complex64" === t.dtype && "complex64" === e.dtype) return this.complexSeparableBinaryOp(t, e, xi); if (this.shouldExecuteOnCPU([t, e])) return this.cpuBackend.subtract(t, e); var n = Pt(t.dtype, e.dtype); if (_().getBool("WEBGL_PACK_BINARY_OPERATIONS")) return this.packedBinaryOp(t, e, xi, t.dtype); var r = new pi(xi, t.shape, e.shape); return this.compileAndRun(r, [t, e], n) }, Ts.prototype.pow = function(t, e) {
        ...
        var g = h ? a[0] * a[1] * (a[2] + 1) : a[0] * a[2] * (a[3] + 1),
            ...
            x = s.shape;
        s.shape = s.shape.slice(), s.shape[s.shape.length - 2]++, P(Ge(s.shape, y.shape), function() { return "packed reshape " + s.shape + " to " + y.shape + " isn't free" });
        ...
        return P(C.isPacked, function() { return "batchMatMul result is expected to be packed" }), s.shape = x, C.shape = n.outShape, Kt.makeTensorFromDataId(w.dataId, n.outShape, w.dtype)
    ...
    }, Ts.prototype.conv2d = function(t, e, n) { if (1 === n.filterHeight && 1 === n.filterWidth && 1 === n.dilationHeight && 1 === n.dilationWidth && 1 === n.strideHeight && 1 === n.strideWidth && ("SAME" === n.padInfo.type || "VALID" === n.padInfo.type)) return this.conv2dByMatMul(t, e, n); if (_().getBool("WEBGL_CONV_IM2COL") && 1 === t.shape[0]) return this.conv2dWithIm2Row(t, e, n); var r = new Mi(n); return this.compileAndRun(r, [t, e]) }, Ts.prototype.conv2dDerInput = function(t, e, n) { var r = new Di(n); return this.compileAndRun(r, [t, e]) }, Ts.prototype.conv2dDerFilter = function(t, e, n) { var r = new Si(n); return this.compileAndRun(r, [t, e]) }, Ts.prototype.fusedDepthwiseConv2D = function(t) {
        var e, n = t.input,
            r = t.filter,
            o = t.convInfo,
            i = t.bias,
    ...
    }, Ts.prototype.split = function(t, e, n) { return Vo(t, e, n) }, Ts.prototype.scatterND = function(t, e, n) {
        var r = Xr(0, t, n),
            o = r.sliceRank,
            i = r.numUpdates,
            a = r.sliceSize,
    ...
    }, Ts.prototype.fft = function(t) { return this.fftImpl(t, !1) }, Ts.prototype.ifft = function(t) { return this.fftImpl(t, !0) }, Ts.prototype.fftImpl = function(t, e) {
        var n = this.texData.get(t.dataId),
        ...
        var h, f = { shape: a.shape, texData: s, isUniform: !1 },
            p = function(t, e, n) {
                var r = "";
        ...
        if (v && (h = this.startTimer()), function(a, s, t, e, n) {
            ...
            }(this.gpgpu, d, l, f, n), c.forEach(function(t) { return i.disposeData(t.dataId) }), v && (h = this.endTimer(h), this.activeTimers.push({ name: o.constructor.name, query: this.getQueryTime(h) })), _().getBool("WEBGL_LAZILY_UNPACK") || !s.isPacked || !1 !== r) return a;
        var m = this.unpackTensor(a);
        return this.disposeData(a.dataId), m
    }, Ts.prototype.compileAndRun = function(t, e, n, r, o) { void 0 === o && (o = !1), n = n || e[0].dtype; var i = this.runWebGLProgram(t, e, n, r, o); return Kt.makeTensorFromDataId(i.dataId, i.shape, i.dtype) }, Ts.prototype.getAndSaveBinary = function(t, e) { return t in this.binaryCache || (this.binaryCache[t] = e()), this.binaryCache[t] }, Ts.prototype.getTextureManager = function() { return this.textureManager }, Ts.prototype.dispose = function() {
        var e = this;
    ...
    }, Ts.prototype.epsilon = function() { return 32 === this.floatPrecision() ? 1e-7 : 1e-4 }, Ts.prototype.uploadToGPU = function(t) {
        var e, n = this.texData.get(t),
            r = n.shape,
            o = n.dtype,
            i = n.values,
    ...
    }, Ts.prototype.computeBytes = function(t, e) { return t[0] * t[1] * U(e) }, Ts);
    ...
    Xt() && Kt.registerBackend("webgl", function() { return new As }, 2);
    var Ns = wn({
            square_: function(t) {
                var n = cn(t, "x", "square"),
                    e = [n];
                return Kt.runKernelFunc(function(t, e) { return e([n]), t.square(n) }, { x: n }, null, "Square", {}, e, [])
            }
        }),
        Fs = "SquaredDifference",
        Ms = wn({
            squaredDifference_: function(t, e) {
                var n, r = cn(t, "a", "squaredDifference"),
                    o = cn(e, "b", "squaredDifference");
                n = Lt(r, o), r = n[0], o = n[1], go(r.shape, o.shape);
                var i = { a: r, b: o },
                    a = [r, o];
                return Kt.runKernelFunc(function(t, e) { var n = t.squaredDifference(r, o); return e([r, o]), n }, i, function(t, e) {
                    var n = e[0],
                        r = e[1],
                        o = kn(2);
        ...
        Gs = wn({
            clipByValue_: function(t, r, o) {
                ...
                var e = [i],
                    n = { min: r, max: o };
                return Kt.runKernelFunc(function(t, e) { var n = t.clip(i, r, o); return e([i]), n }, { x: i }, function(t, e) { var n = e[0]; return { x: function() { return t.where(n.greaterEqual(r).logicalAnd(n.lessEqual(o)), Un(t)) } } }, "ClipByValue", n, e)
            }
        }),
        Hs = wn({
            cos_: function(t) {
                var r = cn(t, "x", "cos"),
                    e = [r];
                return Kt.runKernelFunc(function(t, e) { var n = t.cos(r); return e([r]), n }, { x: r }, function(t, e) { var n = e[0]; return { x: function() { return n.toFloat().sin().neg().mul(t) } } }, "Cos", {}, e)
            }
        }),
        ...
        $s = wn({
            log_: function(t) {
                var r = cn(t, "x", "log"),
                    e = [r];
                return Kt.runKernelFunc(function(t, e) { var n = t.log(r); return e([r]), n }, { x: r }, function(t, e) { var n = e[0]; return { x: function() { return t.div(n.toFloat()) } } }, "Log", {}, e)
            }
        }),
        ...
        Zs = wn({
            neg_: function(t) {
                var e = cn(t, "x", "neg"),
                    n = [e];
                return Kt.runKernelFunc(function(t) { return t.neg(e) }, { x: e }, function(t) { return { x: function() { return t.neg() } } }, "Neg", {}, n)
            }
        }),
        ...
        nu = wn({
            rsqrt_: function(t) {
                var r = cn(t, "x", "rsqrt"),
                    e = [r];
                return Kt.runKernelFunc(function(t, e) { var n = t.rsqrt(r); return e([r]), n }, { x: r }, function(t, e) { var n = e[0]; return { x: function() { return t.div(n.pow(1.5).mul(2)).neg() } } }, "Rsqrt", {}, e)
            }
        }),
        ...
        uu = wn({
            sin_: function(t) {
                var r = cn(t, "x", "sin"),
                    e = [r];
                return Kt.runKernelFunc(function(t, e) { var n = t.sin(r); return e([r]), n }, { x: r }, function(t, e) { var n = e[0]; return { x: function() { return n.toFloat().cos().mul(t) } } }, "Sin", {}, e)
            }
        }),
    ...
    function vu(t, e, n, r, o, i) {
        var a, s, u = cn(t, "x", "batchNorm"),
            c = cn(e, "mean", "batchNorm"),
            l = cn(n, "variance", "batchNorm");
        return null != o && (a = cn(o, "scale", "batchNorm")), null != r && (s = cn(r, "offset", "batchNorm")), P(2 === u.rank, function() { return "Error in batchNorm3D: x must be rank 3 but got rank " + u.rank + "." }), P(2 === c.rank || 1 === c.rank, function() { return "Error in batchNorm2D: mean must be rank 2 or rank 1 but got rank " + c.rank + "." }), P(2 === l.rank || 1 === l.rank, function() { return "Error in batchNorm2D: variance must be rank 2 or rank 1 but got rank " + l.rank + "." }), null != a && P(2 === a.rank || 1 === a.rank, function() { return "Error in batchNorm2D: scale must be rank 2 or rank 1 but got rank " + a.rank + "." }), null != s && P(2 === s.rank || 1 === s.rank, function() { return "Error in batchNorm2D: offset must be rank 2 or rank 1 but got rank " + s.rank + "." }), yu(u, c, l, s, a, i)
    }
    ...
    function mu(t, e, n, r, o, i) {
        var a, s, u = cn(t, "x", "batchNorm"),
            c = cn(e, "mean", "batchNorm"),
            l = cn(n, "variance", "batchNorm");
        return null != o && (a = cn(o, "scale", "batchNorm")), null != r && (s = cn(r, "offset", "batchNorm")), P(3 === u.rank, function() { return "Error in batchNorm3D: x must be rank 3 but got rank " + u.rank + "." }), P(3 === c.rank || 1 === c.rank, function() { return "Error in batchNorm3D: mean must be rank 3 or rank 1 but got rank " + c.rank + "." }), P(3 === l.rank || 1 === l.rank, function() { return "Error in batchNorm3D: variance must be rank 3 or rank 1 but got rank " + l.rank + "." }), null != a && P(3 === a.rank || 1 === a.rank, function() { return "Error in batchNorm3D: scale must be rank 3 or rank 1 but got rank " + a.rank + "." }), null != s && P(3 === s.rank || 1 === s.rank, function() { return "Error in batchNorm3D: offset must be rank 3 or rank 1 but got rank " + s.rank + "." }), yu(u, c, l, s, a, i)
    }
    ...
    function gu(t, e, n, r, o, i) {
        var a, s, u = cn(t, "x", "batchNorm"),
            c = cn(e, "mean", "batchNorm"),
            l = cn(n, "variance", "batchNorm");
        return null != o && (a = cn(o, "scale", "batchNorm")), null != r && (s = cn(r, "offset", "batchNorm")), P(4 === u.rank, function() { return "Error in batchNorm4D: x must be rank 4 but got rank " + u.rank + "." }), P(4 === c.rank || 1 === c.rank, function() { return "Error in batchNorm4D: mean must be rank 4 or rank 1 but got rank " + c.rank + "." }), P(4 === l.rank || 1 === l.rank, function() { return "Error in batchNorm4D: variance must be rank 4 or rank 1 but got rank " + l.rank + "." }), null != a && P(4 === a.rank || 1 === a.rank, function() { return "Error in batchNorm4D: scale must be rank 4 or rank 1 but got rank " + a.rank + "." }), null != s && P(4 === s.rank || 1 === s.rank, function() { return "Error in batchNorm4D: offset must be rank 4 or rank 1 but got rank " + s.rank + "." }), yu(u, c, l, s, a, i)
    }

    function yu(t, e, n, r, o, v) {
        null == v && (v = .001);
        var i, a, m, s = cn(t, "x", "batchNorm"),
        ...
        var l = [s, u, c, i];
        return Kt.runKernelFunc(function(t, e) { var n = t.batchNormalization(m, xu(u), xu(c), v, xu(i), xu(a)); return e([s, u, c, i]), n }, { x: s, mean: u, variance: c, scale: i, offset: a }, function(n, t) {
            var e = t,
                r = e[0],
                o = e[1],
                i = e[2],
            ...
            var h = r.sub(o),
                f = n.mul(s),
                p = nu(i.add(kn(v))),
                d = p.mul(p).mul(p).mul(kn(-.5));
            return {
                x: function() { return 1 === o.rank ? n.mul(Or(p.as4D(1, 1, 1, o.shape[0]), c)).mul(s).reshape(r.shape) : n.mul(p).mul(s).reshape(r.shape) },
                mean: function() { var t = p.mul(kn(-1)).mul(f); return 1 === o.rank && (t = t.sum(u)), t.reshape(o.shape) },
                variance: function() { var t = d.mul(h).mul(f); return 1 === o.rank && (t = t.sum(u)), t.reshape(o.shape) },
                scale: function() {
                    var t = h.mul(p),
                        e = n.mul(t);
    ...
    var Cu = wn({ batchNormalization2d_: function(t, e, n, r, o, i) { return void 0 === r && (r = .001), bu(), vu(t, e, n, i, o, r) } }),
        ...
        Au = wn({
            logicalAnd_: function(t, e) {
                ...
                return go(n.shape, r.shape), Kt.runKernelFunc(function(t) { return t.logicalAnd(n, r) }, { a: n, b: r }, null, "LogicalAnd")
            }
        }),
        ...
        Nu = wn({
            logicalOr_: function(t, e) {
                ...
                return go(n.shape, r.shape), Kt.runKernelFunc(function(t) { return t.logicalOr(n, r) }, { $a: n, $b: r })
            }
        }),
        Fu = wn({
        ...
        Mu = wn({
            where_: function(t, e, n) {
                ...
                return x(r.shape, o.shape, "Error in where: "), 1 === i.rank ? P(i.shape[0] === r.shape[0], function() { return "The first dimension of `a` must match the size of `condition`." }) : x(i.shape, o.shape, "Error in where: "), Kt.runKernelFunc(function(t, e) { var n = t.select(i, r, o); return e([i]), n }, { $condition: i, $a: r, $b: o }, function(t, e) { var n = e[0]; return { $condition: function() { return Un(n).toFloat() }, $a: function() { return t.mul(n.cast(t.dtype)) }, $b: function() { return t.mul(n.logicalNot().cast(t.dtype)) } } })
            }
        }),
        Ou = wn({
            add_: function(t, e) {
                ...
                return Kt.runKernelFunc(function(t) { return t.add(r, o) }, { a: r, b: o }, function(n) {
                    return {
                        a: function() {
                            var t = n,
                                e = mo(r.shape, i);
        ...
        Pu = wn({
            addN_: function(t) {
                ...
                var e = t.map(function(t, e) { return cn(t, "tensors" + e, "addN") }),
                    n = e[0];
                e.forEach(function(t) { if (t.dtype !== n.dtype) throw new Error("All tensors passed to tf.addN() must have the same dtype") }), e.forEach(function(t) { if (!A(t.shape, n.shape)) throw new Error("All tensors passed to tf.addN() must have the same shape") });
                var r = e;
                return Kt.runKernelFunc(function(t) { return t.addN(e) }, r, function(n) { var r = {}; return e.forEach(function(t, e) { r[e] = function() { return n.clone() } }), r }, "AddN")
            }
        }),
        Bu = wn({
        ...
        Lu = wn({
            atan2_: function(t, e) {
                var n, r = cn(t, "a", "atan2"),
                    o = cn(e, "b", "atan2");
                n = Lt(r, o), r = n[0], o = n[1];
                var a = go(r.shape, o.shape);
                return Kt.runKernelFunc(function(t, e) { var n = t.atan2(r, o); return e([r, o]), n }, { $a: r, $b: o }, function(r, t) {
                    var o = t[0],
                        i = t[1];
                    return {
                        $a: function() {
        ...
        Wu = wn({
            div_: function(t, e) {
                ...
                var a = go(r.shape, o.shape);
                return Kt.runKernelFunc(function(t, e) { var n = t.realDivide(r, o); return e([r, o]), n }, { a: r, b: o }, function(r, t) {
                    var o = t[0],
                        i = t[1];
                    return {
                        a: function() {
        ...
        Vu = wn({
            floorDiv_: function(t, e) {
                var n, r = cn(t, "a", "floorDiv"),
                    o = cn(e, "b", "floorDiv");
                n = Lt(r, o), r = n[0], o = n[1];
                var a = go(r.shape, o.shape);
                return Kt.runKernelFunc(function(t, e) { var n = t.floorDiv(r, o); return e([r, o]), n }, { a: r, b: o }, function(r, t) {
                    var o = t[0],
                        i = t[1];
                    return {
                        a: function() {
        ...
        Gu = wn({
            maximum_: function(t, e) {
                var n, r = cn(t, "a", "maximum"),
                    o = cn(e, "b", "maximum");
                return n = Lt(r, o), r = n[0], o = n[1], "bool" === r.dtype && (r = r.toInt(), o = o.toInt()), go(r.shape, o.shape), Kt.runKernelFunc(function(t, e) { var n = t.maximum(r, o); return e([r, o]), n }, { a: r, b: o }, function(t, e) {
                    var n = e[0],
                        r = e[1];
        ...
        qu = wn({
            minimum_: function(t, e) {
                var n, r = cn(t, "a", "minimum"),
                    o = cn(e, "b", "minimum");
                return n = Lt(r, o), r = n[0], o = n[1], "bool" === r.dtype && (r = r.toInt(), o = o.toInt()), go(r.shape, o.shape), Kt.runKernelFunc(function(t, e) { var n = t.minimum(r, o); return e([r, o]), n }, { a: r, b: o }, function(t, e) {
                    var n = e[0],
                        r = e[1];
        ...
        Ku = wn({
            mod_: function(t, e) {
                ...
                n = Lt(r, o), r = n[0], o = n[1];
                var i = go(r.shape, o.shape);
                return Kt.runKernelFunc(function(t, e) { var n = t.mod(r, o); return e([r, o]), n }, { $a: r, $b: o }, function(n, t) {
                    var r = t[0],
                        o = t[1];
                    return {
                        $a: function() { var t = mo(r.shape, i); return 0 < t.length ? n.sum(t).reshape(r.shape) : n },
                        $b: function() {
        ...
        Yu = wn({
            mul_: function(t, e) {
                ...
                n = Lt(r, o), r = n[0], o = n[1];
                var i = go(r.shape, o.shape);
                return Kt.runKernelFunc(function(t, e) { var n = t.multiply(r, o); return e([r, o]), n }, { a: r, b: o }, function(n, t) {
                    var r = t[0],
                        o = t[1];
                    return {
                        a: function() {
        ...
        Ju = wn({
            pow_: function(t, e) {
                var n, r = cn(t, "base", "pow"),
                    o = cn(e, "exp", "pow");
                n = Lt(r, o), r = n[0], o = n[1];
                var u = go(r.shape, o.shape),
                    i = [r, o];
                return Kt.runKernelFunc(function(t, e) { var n = t.pow(r, o); return e([r, o, n]), n }, { a: r, b: o }, function(o, t) {
                    var i = t[0],
                        a = t[1],
                        s = t[2];
                    return {
        ...
        tc = wn({
            sub_: function(t, e) {
                ...
                n = Lt(r, o), r = n[0], o = n[1];
                var i = go(r.shape, o.shape);
                return Kt.runKernelFunc(function(t) { return t.subtract(r, o) }, { a: r, b: o }, function(n) {
                    return {
                        a: function() {
                            var t = n,
                                e = mo(r.shape, i);
        ...
        nc = wn({
            equal_: function(t, e) {
                var n, r = cn(t, "a", "equal"),
                    o = cn(e, "b", "equal");
                return n = Lt(r, o), r = n[0], o = n[1], go(r.shape, o.shape), Kt.runKernelFunc(function(t) { return t.equal(r, o) }, { $a: r, $b: o })
            }
        }),
        rc = wn({
        ...
        oc = wn({
            greater_: function(t, e) {
                var n, r = cn(t, "a", "greater"),
                    o = cn(e, "b", "greater");
                return n = Lt(r, o), r = n[0], o = n[1], go(r.shape, o.shape), Kt.runKernelFunc(function(t) { return t.greater(r, o) }, { a: r, b: o }, null, "Greater")
            }
        }),
        ic = wn({
            greaterEqual_: function(t, e) {
                var n, r = cn(t, "a", "greaterEqual"),
                    o = cn(e, "b", "greaterEqual");
                return n = Lt(r, o), r = n[0], o = n[1], go(r.shape, o.shape), Kt.runKernelFunc(function(t, e) { var n = t.greaterEqual(r, o); return e([r, o]), n }, { a: r, b: o }, function(t, e) {
                    var n = e[0],
                        r = e[1];
                    return { a: function() { return Un(n) }, b: function() { return Un(r) } }
                }, "GreaterEqual")
            }
        }),
        ac = wn({
        ...
        uc = wn({
            less_: function(t, e) {
                var n, r = cn(t, "a", "less"),
                    o = cn(e, "b", "less");
                return n = Lt(r, o), r = n[0], o = n[1], go(r.shape, o.shape), Kt.runKernelFunc(function(t) { return t.less(r, o) }, { a: r, b: o }, null, "Less")
            }
        }),
        cc = wn({
            lessEqual_: function(t, e) {
                var n, r = cn(t, "a", "lessEqual"),
                    o = cn(e, "b", "lessEqual");
                return n = Lt(r, o), r = n[0], o = n[1], go(r.shape, o.shape), Kt.runKernelFunc(function(t, e) { var n = t.lessEqual(r, o); return e([r, o]), n }, { a: r, b: o }, null, "LessEqual")
            }
        }),
        lc = wn({
        ...
        fc = wn({
            notEqual_: function(t, e) {
                var n, r = cn(t, "a", "notEqual"),
                    o = cn(e, "b", "notEqual");
                return n = Lt(r, o), r = n[0], o = n[1], go(r.shape, o.shape), Kt.runKernelFunc(function(t) { return t.notEqual(r, o) }, { a: r, b: o }, null, "NotEqual")
            }
        }),
        pc = wn({
    ...
    function mc(d, v, m) {
        return y(this, void 0, void 0, function() {
            ...
            return R(this, function(t) {
                switch (t.label) {
                    case 0:
                        for (e = cn(d, "tensor", "boolMask"), n = cn(v, "mask", "boolMask", "bool"), r = null == m ? 0 : m, o = n.rank, i = e.shape, P(0 < o, function() { return "mask cannot be scalar" }), x(i.slice(r, r + o), n.shape, "mask's shape must match the first K dimensions of tensor's shape,"), a = 1, s = r; s < r + o; s++) a *= i[s];
    ...
    var gc = wn({
            gather_: function(t, e, g) {
                ...
                return Kt.runKernelFunc(function(t, e) { var n = t.gather(y, r.flatten(), g); return e([r]), n }, { x: y, indices: r }, function(v, t) {
                    var m = t[0];
                    return {
                        x: function() {
                            var t = y.shape,
        ...
        yc = wn({
            unsortedSegmentSum_: function(t, e, r) {
                ...
                return P(B(r), function() { return "numSegments must be of dtype int" }), Kt.runKernelFunc(function(t, e) { var n = t.unsortedSegmentSum(o, i, r); return e([i]), n }, { $x: o }, function(t, e) {
                    var n = e[0];
                    return {
                        $x: function() {
                            return function(t, e) {
    ...
    function xc(t, e, r, o, i, a, s) {
        ...
        var f = Do(a),
            ...
            d = Kt.runKernelFunc(function(t, e) { var n = t.conv2dDerInput(u, r, p); return e([r, u]), n }, { dy4D: u, filter: r }, function(t, e) {
                var n = e[0],
                    r = e[1];
                return { dy4D: function() { return Ec(t, n, o, i, a, 1, s) }, filter: function() { return Ic(t, r, n.shape, o, i, a, s) } }
            });
    ...
    function wc(t, e, n, r, o) {
        ...
        var l = wo(i, n.shape, r, 1, o),
            h = Kt.runKernelFunc(function(t) { return t.conv3dDerInput(a, n, l) }, { dy5D: a });
    ...
    var Cc = wn({
            conv1d_: function(t, e, n, r, o, i, a) {
                ...
                var s = cn(t, "x", "conv1d"),
                    ...
                    c = s,
                    l = !1;
                2 === s.rank && (l = !0, c = s.as3D(1, s.shape[0], s.shape[1])), P(3 === c.rank, function() { return "Error in conv1d: input must be rank 3, but got rank " + c.rank + "." }), P(3 === u.rank, function() { return "Error in conv1d: filter must be rank 3, but got rank " + u.rank + "." }), null != a && P(B(r), function() { return "Error in conv1d: pad must be an integer when using, dimRoundingMode " + a + " but got pad " + r + "." }), P(c.shape[2] === u.shape[1], function() { return "Error in conv1d: depth of input (" + c.shape[2] + ") must match input depth for filter " + u.shape[1] + "." }), P(So(n, i), function() { return "Error in conv1D: Either stride or dilation must be 1. Got stride " + n + " and dilation '" + i + "'" }), P("NWC" === o, function() { return "Error in conv1d: got dataFormat of " + o + " but only NWC is currently supported." });
        ...
        Ec = wn({
            conv2d_: function(t, e, i, a, s, u, n) {
                ...
                P(h === o.shape[2], function() { return "Error in conv2d: depth of input (" + h + ") must match input depth for filter " + o.shape[2] + "." }), P(So(i, u), function() { return "Error in conv2D: Either strides or dilations must be 1. Got strides " + i + " and dilations '" + u + "'" });
                var f = Do(s),
                    p = bo(c.shape, o.shape, i, u, a, n, !1, f),
                    d = [o, c],
                    v = Kt.runKernelFunc(function(t, e) { var n = t.conv2d(c, o, p); return e([o, c]), n }, { x: c, filter: o }, function(t, e) {
                        var n = e,
                            r = n[0],
                            o = n[1];
                        return P(ko(u), function() { return "Error in gradient of conv2D: dilation rates greater than 1 are not yet supported in gradients. Got dilations '" + u + "'" }), { x: function() { return Rc(o.shape, t, r, i, a, s) }, filter: function() { return Ic(o, t, r.shape, i, a, s) } }
                    }, "Conv2D", p, d);
        ...
        _c = wn({
            conv3d_: function(t, e, o, i, n, a) {
                ...
                var h = wo(c.shape, u.shape, o, a, i),
                    f = Kt.runKernelFunc(function(t, e) { var n = t.conv3d(c, u, h); return e([c, u]), n }, { x: c, $filter: u }, function(t, e) {
                        P(bc(a), function() { return "Error in gradient of conv3D: dilation rates greater than 1 are not yet supported in gradients. Got dilations '" + a + "'" });
                        var n = e[0],
                            r = e[1];
                        return {
                            x: function() { return wc(n.shape, t, r, o, i) },
                            $filter: function() {
                                return function(t, e, n, r, o) {
                                    ...
                                    return Kt.runKernelFunc(function(t) { return t.conv3dDerFilter(i, a, s) }, { x5D: i, dy5D: a })
                                }(n, t, r.shape, o, i)
                            }
                        }
                    });
        ...
        Ic = wn({
            conv2dDerFilter_: function(t, e, n, r, o, i, a) {
                ...
                return Kt.runKernelFunc(function(t) { return t.conv2dDerFilter(s, u, f) }, { x4D: s, dy4D: u })
            }
        }),
        ...
        kc = wn({
            depthwiseConv2d_: function(t, e, n, r, o, i, a) {
                ...
                var s = cn(t, "x", "depthwiseConv2d"),
                    ...
                    c = s,
                    l = !1;
                3 === s.rank && (l = !0, c = s.as4D(1, s.shape[0], s.shape[1], s.shape[2])), P(4 === c.rank, function() { return "Error in depthwiseConv2d: input must be rank 4, but got rank " + c.rank + "." }), P(4 === u.rank, function() { return "Error in depthwiseConv2d: filter must be rank 4, but got rank " + u.rank + "." }), P(c.shape[3] === u.shape[2], function() { return "Error in depthwiseConv2d: number of input channels (" + c.shape[3] + ") must match the inChannels dimension in filter " + u.shape[2] + "." }), null == i && (i = [1, 1]), P(So(n, i), function() { return "Error in depthwiseConv2d: Either strides or dilations must be 1. Got strides " + n + " and dilations '" + i + "'" }), null != a && P(B(r), function() { return "Error in depthwiseConv2d: pad must be an integer when using, dimRoundingMode " + a + " but got pad " + r + "." });
                var h = bo(c.shape, u.shape, n, i, r, a, !0),
                    f = [c, u],
                    p = Kt.runKernelFunc(function(t, e) { var n = t.depthwiseConv2D(c, u, h); return e([c, u]), n }, { x: c, filter: u }, function(t, e) {
                        P(ko(i), function() { return "Error in gradient of depthwiseConv2d: dilation rates greater than 1 are not yet supported. Got dilations '" + i + "'" });
                        var n = e[0],
                            r = e[1];
                        return { x: function() { return Sc(n.shape, t, r, h) }, filter: function() { return Dc(n, t, r.shape, h) } }
        ...
        Sc = wn({
            depthwiseConv2dDerInput_: function(t, e, n, r) {
                ...
                var a = Kt.runKernelFunc(function(t) { return t.depthwiseConv2DDerInput(o, n, r) }, { dy4D: o });
        ...
        Dc = wn({
            depthwiseConv2dDerFilter_: function(t, e, n, r) {
                ...
                var i = e;
                return 3 === i.rank && (i = e.as4D(1, e.shape[0], e.shape[1], e.shape[2])), Kt.runKernelFunc(function(t) { return t.depthwiseConv2DDerFilter(o, i, r) }, { x4D: o, dy4D: i })
            }
        }),
        Ac = wn({
            separableConv2d_: function(t, e, n, r, o, i, a) {
                ...
                var f = u.shape[2],
                    p = u.shape[3];
                P(c.shape[2] === f * p, function() { return "Error in separableConv2d: the third dimension of pointwise filter must be " + f * p + ", but got " + c.shape[2] + "." });
        ...
        Fc = wn({
            matMul_: function(t, e, i, a) {
                ...
                var s = i ? r.shape[r.rank - 2] : r.shape[r.rank - 1],
                    ...
                    p = L(h),
                    d = L(f);
                P(2 <= r.rank && 2 <= o.rank && r.rank === o.rank, function() { return "Error in matMul: inputs must have the same rank of at least 2, got ranks " + r.rank + " and " + o.rank + "." }), P(A(h, f), function() { return "Error in matMul: outer dimensions (" + h + ") and (" + f + ") of Tensors with shapes " + r.shape + " and " + o.shape + " must match." }), P(s === u, function() { return "Error in matMul: inner shapes (" + s + ") and (" + u + ") of Tensors with shapes " + r.shape + " and " + o.shape + " and transposeA=" + i + " and transposeB=" + a + " must match." });
                var v = r.shape.slice(0, -2).concat([c, l]),
                    m = i ? r.as3D(p, s, c) : r.as3D(p, c, s),
                    g = a ? o.as3D(d, l, u) : o.as3D(d, u, l),
                    y = { transposeA: i, transposeB: a };
                return Kt.runKernelFunc(function(t, e) { var n = t.batchMatMul(m, g, i, a); return e([m, g]), n }, { a: m, b: g }, function(t, e) {
                    var n = e,
                        r = n[0],
                        o = n[1];
    ...
    function Uc(t, r, o, i, a, e) {
        var n = cn(t, "x", "maxPool"),
            s = n,
            u = !1;
        3 === n.rank && (u = !0, s = n.as4D(1, n.shape[0], n.shape[1], n.shape[2])), null == i && (i = [1, 1]), P(4 === s.rank, function() { return "Error in maxPool: input must be rank 4 but got rank " + s.rank + "." }), P(So(o, i), function() { return "Error in maxPool: Either strides or dilations must be 1. Got strides " + o + " and dilations '" + i + "'" }), null != e && P(B(a), function() { return "Error in maxPool: pad must be an integer when using, dimRoundingMode " + e + " but got pad " + a + "." });
        var c = yo(s.shape, r, o, i, a, e);
        if (1 === c.filterWidth && 1 === c.filterHeight && A(c.inShape, c.outShape)) return n.clone();
        var l = [s],
            h = Kt.runKernelFunc(function(t, e) { var n = t.maxPool(s, c); return e([s, n]), n }, { x: s }, function(h, t) {
                var e = t[0],
                    n = t[1];
                return {
                    x: function() {
                        return function(t, e, n, r, o, i, a) {
                            ...
                            return Kt.runKernelFunc(function(t) { return t.maxPoolBackprop(s, u, c, l) }, { $dy: s, $input: u })
                        }(0, e, n, r, o, i, a)
                    }
                }
            }, "MaxPool", c, l);
    ...
    function Vc(t, e, n, r, o, i) {
        ...
        null == r && (r = [1, 1]), P(So(n, r), function() { return "Error in avgPool: Either strides or dilations must be 1. Got strides " + n + " and dilations '" + r + "'" });
        var s = a,
            u = !1;
        ...
        var l = Kt.runKernelFunc(function(t) { return t.avgPool(s, c) }, { x: s }, function(p) {
            return {
                x: function() {
                    return function(t, e, n, r, o, i) {
                        var a = cn(p, "dy", "avgPoolBackprop"),
                            s = cn(e, "input", "avgPoolBackprop");
                        P(s.rank === a.rank, function() { return "Rank of input (" + s.rank + ") does not match rank of dy (" + a.rank + ")" }), null == o && (o = [1, 1]), P(So(r, o), function() { return "Error in avgPoolBackprop: Either strides or dilations must be 1. Got strides " + r + " and dilations '" + o + "'" });
                        var u = s,
                            c = a,
                            l = !1;
                        ...
                        var h = yo(u.shape, n, r, o, i),
                            f = Kt.runKernelFunc(function(t) { return t.avgPoolBackprop(c, u, h) }, { dy4D: c, input4D: u });
    ...
    var Gc = wn({ maxPool_: function(t, e, n, r, o) { return Uc(t, e, n, 1, r, o) } }),
        ...
        qc = wn({
            pool_: function(t, e, n, r, o, i) {
                ...
                var a = cn(t, "x", "maxPool"),
                    s = a,
                    u = !1;
                3 === a.rank && (u = !0, s = a.as4D(1, a.shape[0], a.shape[1], a.shape[2])), P(So(i, o), function() { return "Error in pool: Either strides or dilations must be 1. Got strides " + i + " and dilations '" + o + "'" });
                var c, l, h, f, p, d, v = yo(s.shape, e, i, o, r),
        ...
        jc = wn({
            maxPool3d_: function(t, r, o, i, a, e, s) {
                ...
                var l = xo(u.shape, r, o, s, i, a, e),
                    h = Kt.runKernelFunc(function(t, e) { var n = t.maxPool3d(u, l); return e([u, n]), n }, { x: u }, function(g, t) {
                        var e = t[0],
                            n = t[1];
                        return {
                            x: function() {
                                return function(t, e, n, r, o, i, a, s) {
                                    ...
                                    var v = xo(f.shape, r, o, i, a, s),
                                        m = Kt.runKernelFunc(function(t) { return t.maxPool3dBackprop(h, f, p, v) }, { dy5D: h, input5D: f });
        ...
        Kc = wn({
            avgPool3d_: function(t, e, n, r, o, i, a) {
                ...
                var s = cn(t, "x", "avgPool3d", "float32"),
                    u = s,
                    c = !1;
                4 === s.rank && (c = !0, u = s.as5D(1, s.shape[0], s.shape[1], s.shape[2], s.shape[3])), null == a && (a = [1, 1, 1]), P(5 === u.rank, function() { return "Error in avgPool3d: x must be rank 5 but got rank " + u.rank + "." }), P("NDHWC" === i, function() { return "Error in avgPool3d: Only NDHWC is currently supported, but got dataFormat of " + i }), P(So(n, a), function() { return "Error in avgPool3d: Either strides or dilations must be 1. Got strides " + n + " and dilations '" + a + "'" }), null != o && P(B(r), function() { return "Error in avgPool3d: pad must be an integer when using, dimRoundingMode " + o + " but got pad " + r + "." });
                var l = xo(u.shape, e, n, a, r, o, i),
                    h = Kt.runKernelFunc(function(t) { return t.avgPool3d(u, l) }, { x: u }, function(d) {
                        return {
                            x: function() {
                                return function(t, e, n, r, o, i, a) {
                                    ...
                                    var f = xo(l.shape, n, r, o, i, a),
                                        p = Kt.runKernelFunc(function(t) { return t.avgPool3dBackprop(c, l, f) }, { dy5D: c, input5D: l });
    ...
    function Zc(e, n, r, t, o) { return n.rank < r.rank && (n = n.reshape(dn(n.shape, t))), e.rank < r.rank && (e = e.reshape(dn(e.shape, t))), { x: function() { var t = e.mul(r.equal(n).cast(e.dtype)); return null == o ? t : t.transpose(o) } } }
    var tl = wn({
            all_: function(t, e, n) {
                ...
                var s = Kt.runKernelFunc(function(t) { return t.all(r, i) }, { $x: r });
                if (n) { var u = dn(s.shape, o); return s.reshape(u) }
                return s
            }
        }),
        el = wn({
            any_: function(t, e, n) {
                ...
                var r = cn(t, "x", "any", "bool"),
                    ...
                    a = mn(i, r.rank);
                null != a && (r = r.transpose(a), i = yn(i.length, r.rank));
                var s = Kt.runKernelFunc(function(t) { return t.any(r, i) }, { $x: r });
                if (n) { var u = dn(s.shape, o); return s.reshape(u) }
                return s
            }
        }),
        nl = wn({
            argMax_: function(t, e) {
                ...
                var i = { axis: o[0] },
                    a = [r];
                return Kt.runKernelFunc(function(t, e) { var n = t.argMax(r, o[0]); return e([r]), n }, { x: r }, function(t, e) { var n = e[0]; return { x: function() { return Un(n) } } }, "ArgMax", i, a)
            }
        }),
        rl = wn({
            argMin_: function(t, e) {
                ...
                var o = D(e, r.shape),
                    n = mn(o, r.rank);
                return null != n && (r = r.transpose(n), o = yn(o.length, r.rank)), Kt.runKernelFunc(function(t, e) { var n = t.argMin(r, o[0]); return e([r]), n }, { $x: r }, function(t, e) { var n = e[0]; return { $x: function() { return Un(n) } } })
            }
        }),
        ol = wn({
        ...
        il = wn({
            max_: function(t, e, n) {
                ...
                var u = [r],
                    c = Kt.runKernelFunc(function(t, e) { var n = t.max(r, a); return e([o, n]), n }, { x: r }, function(t, e) { return Zc(t, e[1], e[0], i, s) }, "Max", { axes: a }, u, [!0]);
                if (n) {
                    var l = dn(c.shape, i);
                    c = c.reshape(l)
                }
        ...
        al = wn({
            mean_: function(t, e, r) {
                ...
                var n = cn(t, "x", "mean"),
                    o = D(e, n.shape),
                    i = L(pn(n.shape, o)[1]);
                return io(function(n) { var t = kn(i); return { value: (t.dtype === n.dtype ? n : n.cast(t.dtype)).div(t).sum(e, r), gradFunc: function(t) { var e = n.shape.slice(); return o.forEach(function(t) { e[t] = 1 }), t.reshape(e).mul(On(n.shape, "float32")).div(i) } } })(n)
            }
        }),
        sl = wn({
            min_: function(t, e, n) {
                ...
                null != s && (r = r.transpose(s), a = yn(a.length, r.rank));
                var u = [r],
                    c = Kt.runKernelFunc(function(t, e) { var n = t.min(r, a); return e([o, n]), n }, { x: r }, function(t, e) { return Zc(t, e[1], e[0], i, s) }, "Min", { axes: a }, u, [!0]);
                if (n) {
                    var l = dn(c.shape, i);
                    c = c.reshape(l)
                }
        ...
        cl = wn({
            sum_: function(t, e, u) {
                ...
                return io(function(n) {
                    ...
                    function o(t) { var e = n.shape.slice(); return c.forEach(function(t) { e[t] = 1 }), t.reshape(e).mul(On(n.shape, "float32")) }
                    var i = { axes: e },
                        a = Kt.runKernelFunc(function(t) { return t.sum(r, e) }, { x: r }, function(t) { return { x: function() { return o(t) } } }, "Sum", i);
                    if (u) {
                        var s = dn(a.shape, c);
                        a = a.reshape(s)
                    }
        ...
        ll = wn({
            prod_: function(t, e, n) {
                ...
                var u = Kt.runKernelFunc(function(t) { return t.prod(s, a) }, { permutedX: s });
                if (n) {
                    var c = dn(u.shape, o);
                    u = u.reshape(c)
                }
        ...
        pl = wn({
            prelu_: function(t, e) {
                var r = cn(t, "x", "prelu"),
                    o = cn(e, "alpha", "prelu");
                return Kt.runKernelFunc(function(t, e) { var n = t.prelu(r, o); return e([r, o]), n }, { x: r, alpha: o }, function(n, t) {
                    var r = t[0],
                        o = t[1],
                        i = r.greater(0);
                    return {
                        x: function() { return Mu(i, n, n.mul(o)) },
                        alpha: function() {
        ...
        vl = wn({
            relu6_: function(t) {
                var r = cn(t, "x", "relu6");
                return "bool" === r.dtype ? r.toInt() : Kt.runKernelFunc(function(t, e) { var n = t.relu6(r); return e([r]), n }, { x: r }, function(t, e) {
                    var n = e[0],
        ...
        ml = wn({
            selu_: function(t) {
                var r = cn(t, "x", "selu");
                return Kt.runKernelFunc(function(t, e) { var n = t.selu(r); return e([r]), n }, { $x: r }, function(i, t) {
                    var a = t[0];
                    return {
                        $x: function() {
        ...
        yl = wn({
            localResponseNormalization_: function(t, o, i, a, s) {
                ...
                var u = Kt.runKernelFunc(function(t, e) { var n = t.localResponseNormalization4D(r, o, i, a, s); return e([r, n]), n }, { x4D: r }, function(e, t) {
                    var n = t[0],
                        r = t[1];
                    return { x4D: function() { return Kt.runKernelFunc(function(t) { return t.LRNGrad(e, n, r, o, i, a, s) }, {}) } }
                });
        ...
        Cl = wn({
            movingAverage_: function(t, e, n, r, o) {
                ...
                Wt(i, a), P(A(i.shape, a.shape), function() { return "Shape mismatch in v and x" });
                var u = kn(1),
                    c = u.sub(s),
                    l = a.sub(i).mul(c);
                if (o) {
        ...
        El = wn({
            stridedSlice_: function(t, e, n, r, o, i, a, s, u) {
                ...
                var p = Jr(u);
                p.forEach(function(t) { n[t] = e[t] + 1, r[t] = 1 });
                var d = Qr(e, n, r),
                    v = d.filter(function(t, e) { return -1 === p.indexOf(e) });
                return r.every(function(t) { return 1 === t }) ? Xc(c, e, d).reshape(v) : Kt.runKernelFunc(function(t) { return t.stridedSlice(c, e, n, r) }, { $x: c }).reshape(v)
            }
        }),
        ...
        Il = wn({
            scatterND_: function(t, e, n) {
                ...
                return Kr(o, r, n), Kt.runKernelFunc(function(t) { return t.scatterND(r, o, n) }, { indices: r, updates: o }, null, "ScatterNd", { shape: n })
            }
        }),
        Rl = wn({
            fft_: function(t) {
                ...
                var e = t.shape[t.shape.length - 1],
                    n = t.size / e,
                    r = t.as2D(n, e);
                return Kt.runKernelFunc(function(t) { return t.fft(r) }, { input: t }).reshape(t.shape)
            }
        }),
        kl = wn({
            ifft_: function(t) {
                ...
                var e = t.shape[t.shape.length - 1],
                    n = t.size / e,
                    r = t.as2D(n, e);
                return Kt.runKernelFunc(function(t) { return t.ifft(r) }, { input: t }).reshape(t.shape)
            }
        }),
        Sl = wn({
            rfft_: function(t, e) {
        ...
        Tl = wn({
            sparseToDense_: function(t, e, n, r) {
                ...
                }(o, i, n, a), Kt.runKernelFunc(function(t) { return t.sparseToDense(o, i, n, a) }, { $sparseIndices: o, $sparseValues: i, $defaultValue: a })
            }
        }),
        Nl = wn({
            gatherND_: function(t, e) {
                var n = cn(e, "indices", "gatherND", "int32"),
                    r = cn(t, "x", "gatherND");
                return Kt.runKernelFunc(function(t) { return t.gatherND(r, n) }, { x: r, indices: n }, null, "GatherNd")
            }
        }),
        Fl = wn({
            diag_: function(t) {
                ...
                return Kt.runKernelFunc(function(t) { return t.diag(e) }, { $x: e }).reshape(n)
            }
        }),
        Ml = wn({
            dropout_: function(t, e, n, r) {
                var o = cn(t, "x", "dropout");
                if (P("float32" === o.dtype, function() { return "x has to be a floating point tensor since it's going to be scaled, but got a " + o.dtype + " tensor instead." }), P(0 <= e && e < 1, function() { return "rate must be a float in the range [0, 1), but got " + e + "." }), 0 === e) return t instanceof bt ? o.clone() : o;
                var i = function(t, e) { if (null == e) return t.shape.slice(); if (A(t.shape, e)) return e; if (t.shape.length !== e.length) return e; for (var n = [], r = 0; r < t.shape.length; r++) null == e[r] && null != t.shape[r] ? n.push(t.shape[r]) : n.push(e[r]); return n }(o, n),
                    a = 1 - e,
                ...
                switch (t.label) {
                    ...
                    case 2:
                        for (i = t.sent(), a = [o.length / r, r], u = a[1], c = N("bool", s = a[0]), l = 0; l < s; l++) {
                            ...
                            for (p.sort(function(t, e) { return e.value - t.value }), c[l] = 0, d = 0; d < g; d++)
                                if (p[d].index === i[l]) { c[l] = 1; break }
                        }
    ...
    var Bl, Ll, Wl = wn({ hannWindow_: function(t) { return Ol(t, .5, .5) } }),
        ...
        Xl = wn({
            huberLoss_: function(t, e, n, r, o) {
                ...
                var u = kn(r),
                    ...
                    l = qu(c, u),
                    h = c.sub(l),
                    f = kn(.5).mul(l.square()).add(u.mul(h));
                return ql(f, s, o)
            }
        }),
        Yl = wn({
    ...
    function th(r, o) {
        return void 0 === o && (o = !1), Kt.tidy(function() {
            ...
            for (var p = r.shape[0], d = r.shape[1], v = xr(p), m = r.clone(), g = Dn([
                    [1]
                ], [1, 1]), y = g.clone(), t = d <= p ? d : p, e = function(f) {
                    var t, e = m,
                        n = y,
                        r = v;
    ...
    var eh = wn({
            bandPart_: function(t, e, n) {
                ...
                var u = Wn(0, a, 1, "int32").reshape([-1, 1]),
                    ...
                    f = Pn([a, s], r.dtype);
                return Mr(Br(r.reshape([-1, a, s])).map(function(t) { return Mu(h, t, f) })).reshape(o)
            }
        }),
        nh = wn({
    ...
    function ch(t, e, n) { if ("linear" === e) return t; if ("relu" === e) return dl(t); if ("elu" === e) return hl(t); if ("relu6" === e) return vl(t); if ("prelu" === e) return pl(t, n); throw new Error("Unknown fused activation " + e + ".") }
    var lh = wn({
            resizeBilinear_: function(t, e, r) {
                ...
                var a = e[0],
                    s = e[1],
                    u = Kt.runKernelFunc(function(t, e) { return e([o]), t.resizeBilinear(o, a, s, r) }, { x: o }, function(e, n) { return { x: function() { return Kt.runKernelFunc(function(t) { return t.resizeBilinearBackprop(e, n[0], r) }, {}) } } }, "ResizeBilinear", { alignCorners: r, newHeight: a, newWidth: s });
        ...
        hh = wn({
            resizeNearestNeighbor_: function(t, e, r) {
                ...
                var a = e[0],
                    s = e[1],
                    u = Kt.runKernelFunc(function(t, e) { return e([o]), t.resizeNearestNeighbor(o, a, s, r) }, { batchImages: o }, function(e, n) { return { batchImages: function() { return Kt.runKernelFunc(function(t) { return t.resizeNearestNeighborBackprop(e, n[0], r) }, {}) } } });
                return i ? u.as3D(u.shape[1], u.shape[2], u.shape[3]) : u
            }
        }),
        fh = wn({
            nonMaxSuppression_: function(t, e, n, r, o) {
                ...
                return Kt.runKernelFunc(function(t) { return t.nonMaxSuppression(i, a, n, r, o) }, { boxes: i, scores: a }, null, "NonMaxSuppressionV3", u)
            }
        }),
        ph = wn({
        ...
        mh = wn({
            fusedMatMul_: function(t) {
                ...
                if (!1 === ah(Kt.state.gradientDepth, l)) { var f = Fc(n, r, s, u); return null != c && (f = Ou(f, c)), ch(f, l, h) }
                ...
                var v = s ? p.shape[p.rank - 2] : p.shape[p.rank - 1],
                    ...
                    w = L(x),
                    C = L(b);
                P(2 <= p.rank && 2 <= d.rank && p.rank === d.rank, function() { return "Error in fused matMul: inputs must have the same rank of at least 2, got ranks " + p.rank + " and " + d.rank + "." }), P(A(x, b), function() { return "Error in fused matMul: outer dimensions (" + x + ") and (" + b + ") of Tensors with shapes " + p.shape + " and " + d.shape + " must match." }), P(v === m, function() { return "Error in fused matMul: inner shapes (" + v + ") and (" + m + ") of Tensors with shapes " + p.shape + " and " + d.shape + " and transposeA=" + s + " and transposeB=" + u + " must match." });
                var E, _, I = p.shape.slice(0, -2).concat([g, y]),
                ...
                var D = [R, k];
                return Kt.runKernelFunc(function(t, e) { var n = t.fusedBatchMatMul({ a: R, b: k, transposeA: s, transposeB: u, bias: E, activation: l, preluActivationWeights: _ }); return e([R, k, n]), n }, S, function(t, e) {
                    var n = e[0],
                        r = e[1],
                        o = e[2],
                        i = sh(t, o, l),
        ...
        gh = wn({
            fusedConv2d_: function(t) {
                ...
                if (f = f || "linear", !1 === ah(Kt.state.gradientDepth, f)) { var d = Ec(e, n, u, c, o, l, a); return null != h && (d = Ou(d, h)), ch(d, f, p) }
                var v = cn(e, "x", "conv2d"),
                    m = cn(n, "filter", "conv2d"),
                    g = v,
                    y = !1;
                3 === v.rank && (y = !0, g = v.as4D(1, v.shape[0], v.shape[1], v.shape[2])), P(4 === g.rank, function() { return "Error in fused conv2d: input must be rank 4, but got rank " + g.rank + "." }), P(4 === m.rank, function() { return "Error in fused conv2d: filter must be rank 4, but got rank " + m.rank + "." }), null != a && P(B(c), function() { return "Error in fused conv2d: pad must be an integer when using, dimRoundingMode " + a + " but got pad " + c + "." }), P(g.shape[3] === m.shape[2], function() { return "Error in conv2d: depth of input (" + g.shape[3] + ") must match input depth for filter " + m.shape[2] + "." }), P(So(u, l), function() { return "Error in conv2D: Either strides or dilations must be 1. Got strides " + u + " and dilations '" + l + "'" }), P("NHWC" === o, function() { return "Error in conv2d: got dataFormat of " + o + " but only NHWC is currently supported." });
                ...
                var E = [m, g],
                    _ = Kt.runKernelFunc(function(t, e) { var n = t.fusedConv2d({ input: g, filter: m, convInfo: w, bias: x, activation: f, preluActivationWeights: b }); return e([m, g, n]), n }, C, function(t, e) {
                        var n = e,
                            r = n[0],
                            o = n[1],
                            i = n[2],
                            a = sh(t, i, f);
                        P(ko(l), function() { return "Error in gradient of fused conv2D: dilation rates greater than 1 are not yet supported in gradients. Got dilations '" + l + "'" });
                        var s = {};
                        return null != h && (s = { bias: function() { return uh(x, a) } }), Object.assign({ x: function() { return Rc(o.shape, a, r, u, c) }, filter: function() { return Ic(o, a, r.shape, u, c) } }, s)
        ...
        yh = wn({
            fusedDepthwiseConv2d_: function(t) {
                var e = t.x,
                    ...
                    f = void 0 === h ? "linear" : h,
                    p = t.preluActivationWeights;
                if (!1 === ah(Kt.state.gradientDepth, f)) { var d = kc(e, n, r, o, a, u, c); return null != l && (d = Ou(d, l)), ch(d, f, p) }
                var v = cn(e, "x", "depthwiseConv2d"),
                    m = cn(n, "filter", "depthwiseConv2d"),
                    g = v,
                    y = !1;
                3 === v.rank && (y = !0, g = v.as4D(1, v.shape[0], v.shape[1], v.shape[2])), P(4 === g.rank, function() { return "Error in fused depthwiseConv2d: input must be rank 4, but got rank " + g.rank + "." }), P(4 === m.rank, function() { return "Error in fused depthwiseConv2d: filter must be rank 4, but got rank " + m.rank + "." }), P(g.shape[3] === m.shape[2], function() { return "Error in fused depthwiseConv2d: number of input channels (" + g.shape[3] + ") must match the inChannels dimension in filter " + m.shape[2] + "." }), null == u && (u = [1, 1]), P(So(r, u), function() { return "Error in fused depthwiseConv2d: Either strides or dilations must be 1. Got strides " + r + " and dilations '" + u + "'" }), null != c && P(B(o), function() { return "Error in fused depthwiseConv2d: pad must be an integer when using dimRoundingMode " + c + " but got pad " + o + "." });
                ...
                var E = [m, g],
                    _ = Kt.runKernelFunc(function(t, e) { var n = t.fusedDepthwiseConv2D({ input: g, filter: m, convInfo: w, bias: x, activation: f, preluActivationWeights: b }); return e([m, g, n]), n }, C, function(t, e) {
                        P(ko(u), function() { return "Error in gradient of fused depthwiseConv2d: dilation rates greater than 1 are not yet supported. Got dilations '" + u + "'" });
                        var n = e[0],
                            r = e[1],
                            o = e[2],
                            i = sh(t, o, f),
                            a = {};
                        return null != l && (a = { bias: function() { return uh(x, i) } }), Object.assign({ x: function() { return Sc(r.shape, i, n, w) }, filter: function() { return Dc(r, i, n.shape, w) } }, a)
    ...
    function Ch(t, e, n, r) { if ("linear" === n) return t.linear(e); if ("relu" === n) return t.relu(e); if ("elu" === n) return t.elu(e); if ("relu6" === n) return t.relu6(e); if ("prelu" === n) return t.prelu(e, r); throw new Error("Activation " + n + " has not been implemented for the CPU backend.") }
    var Eh, _h = (t(Ih, Eh = lo), Ih.prototype.write = function(t, e, n) { this.firstUse && (this.firstUse = !1, _().get("IS_NODE") && an("\n============================\nHi there 👋. Looks like you are running TensorFlow.js in Node.js. To speed things up dramatically, install our node backend, which binds to TensorFlow C++, by running npm i @tensorflow/tfjs-node, or npm i @tensorflow/tfjs-node-gpu if you have CUDA. Then call require('@tensorflow/tfjs-node'); (-gpu suffix for CUDA) at the start of your program. Visit https://github.com/tensorflow/tfjs-node for more details.\n============================")); var r = {}; return this.data.set(r, { values: t, dtype: n }), r }, Ih.prototype.move = function(t, e, n, r) { this.data.set(t, { values: e, dtype: r }) }, Ih.prototype.numDataIds = function() { return this.data.numDataIds() }, Ih.prototype.read = function(e) { return y(this, void 0, void 0, function() { return R(this, function(t) { return [2, this.readSync(e)] }) }) }, Ih.prototype.readSync = function(t) {
    ...
    }, Ih.prototype.makeOutput = function(t, e, n) { var r = this.write(t, e, n); return Kt.makeTensorFromDataId(r, e, n, this) }, Ih.prototype.disposeData = function(t) {
        if (this.data.has(t)) {
            var e = this.data.get(t).complexTensors;
            null != e && (e.real.dispose(), e.imag.dispose()), this.data.delete(t)
        }
    }, Ih.prototype.time = function(n) { return y(this, void 0, void 0, function() { var e; return R(this, function(t) { return e = tt(), n(), [2, { kernelMs: tt() - e }] }) }) }, Ih.prototype.memory = function() { return { unreliable: !0, reasons: ["The reported memory is an upper bound. Due to automatic garbage collection, the true allocated memory may be less."] } }, Ih.prototype.complex = function(t, e) { var n = this.makeOutput(null, t.shape, "complex64"); return this.data.get(n.dataId).complexTensors = { real: Kt.keep(t.clone()), imag: Kt.keep(e.clone()) }, n }, Ih.prototype.real = function(t) { return this.data.get(t.dataId).complexTensors.real.clone() }, Ih.prototype.imag = function(t) { return this.data.get(t.dataId).complexTensors.imag.clone() }, Ih.prototype.slice = function(t, n, e) {
        ...
        wh(t, "stridedSlice");
        var o = Qr(e, n, r);
        if (o.some(function(t) { return 0 === t })) return In([], o);
        ...
        return i.toTensor()
    }, Ih.prototype.diag = function(t) { for (var e = this.readSync(t.dataId), n = cr([t.size, t.size], t.dtype), r = n.values, o = 0; o < e.length; o++) r[o * t.size + o] = e[o]; return n.toTensor() }, Ih.prototype.unstack = function(t, e) {
        for (var n = t.shape[e], r = new Array(t.rank - 1), o = 0, i = 0; i < t.rank; i++) i !== e && (r[o++] = t.shape[i]);
        var a = new Array(t.rank).fill(0),
            s = t.shape.slice();
        s[e] = 1;
        ...
        var a = this;
        if ("complex64" === t[0].dtype) {
            var e = t.map(function(t) { return En(t) }),
                r = t.map(function(t) { return _n(t) });
        ...
        var l = bn(t.map(function(t) { return t.shape }), n);
        return In(u, l, t[0].dtype)
    }, Ih.prototype.neg = function(t) { return wh(t, "neg"), this.multiply(kn(-1), t) }, Ih.prototype.add = function(t, e) { return "complex64" === t.dtype || "complex64" === e.dtype ? this.broadcastedBinaryComplexOp(t.cast("complex64"), e.cast("complex64"), function(t, e, n, r) { return { real: t + n, imag: e + r } }) : this.broadcastedBinaryOp(t, e, Pt(t.dtype, e.dtype), function(t, e) { return t + e }) }, Ih.prototype.addN = function(t) {
        var e = this;
        wh(t, "addN");
        for (var n = t.map(function(t) { return e.readSync(t.dataId) }), r = cr(t[0].shape, t[0].dtype), o = r.values, i = 0; i < t.length; i++)
        ...
        var n = D([e], t.shape),
            ...
            s = this.sum(a, n).reshape(o);
        return this.realDivide(a, s)
    }, Ih.prototype.subtract = function(t, e) { return "complex64" === t.dtype || "complex64" === e.dtype ? this.broadcastedBinaryComplexOp(t.cast("complex64"), e.cast("complex64"), function(t, e, n, r) { return { real: t - n, imag: e - r } }) : this.broadcastedBinaryOp(t, e, Pt(t.dtype, e.dtype), function(t, e) { return t - e }) }, Ih.prototype.pow = function(t, e) { return wh([t, e], "pow"), this.broadcastedBinaryOp(t, e, t.dtype, function(t, e) { return Math.pow(t, e) }) }, Ih.prototype.batchMatMul = function(t, e, n, r) {
        wh([t, e], "matMul");
        ...
        for (var o = Pt(t.dtype, "int32"), i = Pn(t.shape, o), a = this.readSync(i.dataId), s = this.readSync(t.dataId), u = t.shape[t.rank - 1], c = r ? function(t, e) { return t + u - e - 1 } : function(t, e) { return t + e }, l = 0; l < s.length; l += u)
            for (var h = 0; h < u; h++) {
                var f = c(l, h);
                if (0 === h) a[f] = n ? 0 : s[f];
                else {
        ...
        return i
    }, Ih.prototype.equal = function(t, e) { return wh([t, e], "equal"), this.broadcastedBinaryOp(t, e, "bool", function(t, e) { return t === e ? 1 : 0 }) }, Ih.prototype.notEqual = function(t, e) { return wh([t, e], "notEqual"), this.broadcastedBinaryOp(t, e, "bool", function(t, e) { return t !== e ? 1 : 0 }) }, Ih.prototype.less = function(t, e) { return wh([t, e], "less"), this.broadcastedBinaryOp(t, e, "bool", function(t, e) { return t < e ? 1 : 0 }) }, Ih.prototype.lessEqual = function(t, e) { return wh([t, e], "lessEqual"), this.broadcastedBinaryOp(t, e, "bool", function(t, e) { return t <= e ? 1 : 0 }) }, Ih.prototype.greater = function(t, e) { return wh([t, e], "greater"), this.broadcastedBinaryOp(t, e, "bool", function(t, e) { return e < t ? 1 : 0 }) }, Ih.prototype.greaterEqual = function(t, e) { return wh([t, e], "greaterEqual"), this.broadcastedBinaryOp(t, e, "bool", function(t, e) { return e <= t ? 1 : 0 }) }, Ih.prototype.logicalNot = function(t) { wh(t, "logicalNot"); for (var e = this.readSync(t.dataId), n = new Uint8Array(e.length), r = 0; r < e.length; ++r) n[r] = e[r] ? 0 : 1; return this.makeOutput(n, t.shape, "bool") }, Ih.prototype.logicalAnd = function(t, e) { return wh([t, e], "logicalAnd"), this.broadcastedBinaryOp(t, e, "bool", function(t, e) { return t && e }) }, Ih.prototype.logicalOr = function(t, e) { return wh([t, e], "logicalOr"), this.broadcastedBinaryOp(t, e, "bool", function(t, e) { return t || e }) }, Ih.prototype.select = function(t, e, n) {
        wh([t, e, n], "select");
        for (var r = this.readSync(t.dataId), o = this.readSync(e.dataId), i = this.readSync(n.dataId), a = Pn(e.shape, Pt(e.dtype, n.dtype)), s = this.readSync(a.dataId), u = 0, c = 0 === t.rank || 1 < t.rank || 1 === e.rank ? 1 : L(e.shape.slice(1)), l = 0; l < r.length; l++)
            for (var h = 0; h < c; h++) 1 === r[l] ? s[u++] = o[l] : s[u++] = i[l];
        return a
    }, Ih.prototype.where = function(t) { wh([t], "where"); var e = this.readSync(t.dataId); return qo(t.shape, e) }, Ih.prototype.topk = function(t, e, n) { return wh(t, "topk"), Ho(this.readSync(t.dataId), t.shape, t.dtype, e) }, Ih.prototype.min = function(t, e) {
        ...
        return i
    }, Ih.prototype.minimum = function(t, e) { return wh([t, e], "minimum"), this.broadcastedBinaryOp(t, e, t.dtype, function(t, e) { return Math.min(t, e) }) }, Ih.prototype.mod = function(t, e) { return wh([t, e], "mod"), this.broadcastedBinaryOp(t, e, t.dtype, function(t, e) { var n = t % e; return t < 0 && e < 0 || 0 <= t && 0 <= e ? n : (n + e) % e }) }, Ih.prototype.max = function(t, e) {
        ...
        return i
    }, Ih.prototype.maximum = function(t, e) { return wh([t, e], "maximum"), this.broadcastedBinaryOp(t, e, t.dtype, function(t, e) { return Math.max(t, e) }) }, Ih.prototype.all = function(t, e) {
    ...
    }, Ih.prototype.exp = function(t) { wh(t, "exp"); for (var e = this.readSync(t.dataId), n = new Float32Array(e.length), r = 0; r < e.length; ++r) n[r] = Math.exp(e[r]); return this.makeOutput(n, t.shape, "float32") }, Ih.prototype.expm1 = function(t) { wh(t, "expm1"); for (var e = this.readSync(t.dataId), n = new Float32Array(e.length), r = 0; r < e.length; ++r) n[r] = Math.expm1(e[r]); return this.makeOutput(n, t.shape, "float32") }, Ih.prototype.log = function(t) {
        wh(t, "log");
        for (var e = this.readSync(t.dataId), n = new Float32Array(e.length), r = 0; r < e.length; ++r) {
            var o = e[r];
            n[r] = Math.log(o)
        ...
        return this.makeOutput(n, t.shape, "float32")
    }, Ih.prototype.reciprocal = function(t) { wh(t, "reciprocal"); for (var e = this.readSync(t.dataId), n = new Float32Array(e.length), r = 0; r < e.length; ++r) n[r] = 1 / e[r]; return this.makeOutput(n, t.shape, "float32") }, Ih.prototype.linear = function(t) { return t }, Ih.prototype.relu = function(t) { wh(t, "relu"); for (var e = Pn(t.shape, t.dtype), n = this.readSync(e.dataId), r = this.readSync(t.dataId), o = 0; o < r.length; ++o) n[o] = Math.max(0, r[o]); return e }, Ih.prototype.relu6 = function(t) { wh(t, "relu"); for (var e = Pn(t.shape, t.dtype), n = this.readSync(e.dataId), r = this.readSync(t.dataId), o = 0; o < r.length; ++o) n[o] = Math.min(Math.max(0, r[o]), 6); return e }, Ih.prototype.prelu = function(t, e) { return wh([t, e], "prelu"), this.broadcastedBinaryOp(t, e, t.dtype, function(t, e) { return t < 0 ? e * t : t }) }, Ih.prototype.elu = function(t) {
        wh(t, "elu");
    ...
    }, Ih.prototype.abs = function(t) { for (var e = new Float32Array(t.size), n = this.readSync(t.dataId), r = 0; r < n.length; ++r) e[r] = Math.abs(n[r]); return this.makeOutput(e, t.shape, "float32") }, Ih.prototype.complexAbs = function(t) {
        ...
        return this.makeOutput(e, t.shape, "float32")
    }, Ih.prototype.int = function(t) { wh(t, "int"); for (var e = new Int32Array(t.size), n = this.readSync(t.dataId), r = 0; r < n.length; ++r) e[r] = n[r]; return this.makeOutput(e, t.shape, "int32") }, Ih.prototype.sigmoid = function(t) { wh(t, "sigmoid"); for (var e = new Float32Array(t.size), n = this.readSync(t.dataId), r = 0; r < n.length; ++r) e[r] = 1 / (1 + Math.exp(-n[r])); return this.makeOutput(e, t.shape, "float32") }, Ih.prototype.softplus = function(t) {
        wh(t, "softplus");
            ...
            for (var O = 0; O < d; ++O)
                for (var P = 0; P < v; ++P)
                    for (var B = P - E, L = Math.max(0, Math.ceil(B / b)), W = Math.min(y, (f + B) / b), z = 0; z < m; ++z) {
                        for (var U = z - _, V = Math.max(0, Math.ceil(U / w)), G = Math.min(x, (p + U) / w), H = 0, q = L; q < W; ++q)
        ...
        return s.toTensor()
    }, Ih.prototype.tile = function(t, e) { return wh(t, "tile"), Go(this.bufferSync(t), e) }, Ih.prototype.pad = function(n, t, e) {
        wh(n, "pad");
            ...
            for (var x = y * v, b = y * t.strides[0], w = 0; w < e.inChannels; ++w)
                for (var C = 0; C < e.outHeight; ++C)
                    for (var E = C * r - c, _ = Math.max(0, E), I = Math.min(e.inHeight, s + E), R = x + C * m, k = 0; k < e.outWidth; ++k) {
                        for (var S = k * o - l, D = Math.max(0, S), A = Math.min(e.inWidth, u + S), T = h, N = 0, F = 0, M = _; M < I; M += i) { for (var O = b + M * t.strides[1], P = D; P < A; P += a) { var B = f[O + P * t.strides[2] + w]; "max" === n && T < B ? T = B : "avg" === n && (N += B, F++) } if (isNaN(T)) break }
                        d[R + k * g + w] = "avg" === n ? N / F : T
                    }
        return p.toTensor()
    }, Ih.prototype.maxPool = function(t, e) { return this.pool(t, e, "max") }, Ih.prototype.maxPoolPositions = function(t, e) {
        ...
        return g.toTensor()
    }, Ih.prototype.avgPool3d = function(t, e) { return wh(t, "avgPool3d"), this.pool3d(t, e, "avg").toFloat() }, Ih.prototype.avgPool3dBackprop = function(t, e, n) {
        ...
        return y.toTensor()
    }, Ih.prototype.maxPool3d = function(t, e) { return wh(t, "maxPool3d"), this.pool3d(t, e, "max").toFloat() }, Ih.prototype.maxPool3dPositions = function(t, e) {
        ...
        return g.toTensor()
    }, Ih.prototype.cast = function(t, e) { return Ao(t, e, this) }, Ih.prototype.reshape = function(t, e) { return To(t, e) }, Ih.prototype.avgPool = function(t, e) { return wh(t, "avgPool"), this.pool(t, e, "avg").toFloat() }, Ih.prototype.resizeBilinear = function(t, e, n, r) {
        wh(t, "resizeBilinear");
    ...
    }, Ih.prototype.nonMaxSuppression = function(t, e, n, r, o) { return wh(t, "nonMaxSuppression"), Bo(this.readSync(t.dataId), this.readSync(e.dataId), n, r, o) }, Ih.prototype.fft = function(t) { return this.fftBatch(t, !1) }, Ih.prototype.ifft = function(t) { return this.fftBatch(t, !0) }, Ih.prototype.fftBatch = function(t, e) {
        ...
        var n = t.as1D(),
            r = n.size;
        if (this.isExponentOf2(r)) { var o = this.fftRadix2(n, r, e).as2D(t.shape[0], t.shape[1]); return e && (o = Cn(En(o).div(kn(r)), _n(o).div(kn(r)))), o }
    ...
    }, Ih.prototype.isExponentOf2 = function(t) { return 0 == (t & t - 1) }, Ih.prototype.fftRadix2 = function(t, e, n) {
        if (1 === e) return t;
    ...
    }, Ih.prototype.split = function(t, e, n) { return Vo(t, e, n) }, Ih.prototype.dispose = function() {}, Ih.prototype.floatPrecision = function() { return 32 }, Ih.prototype.epsilon = function() { return 1e-7 }, Ih.prototype.cropAndResize = function(t, e, n, r, o, i) {
    ...
    }, Ih.prototype.fill = function(t, e, n) { var r = F(n = n || j(e), L(t)); return r.fill(e), Kt.makeTensor(r, t, n, this) }, Ih.prototype.onesLike = function(t) { if ("string" === t.dtype) throw new Error("onesLike is not supported for string tensors"); return this.fill(t.shape, 1, t.dtype) }, Ih.prototype.zerosLike = function(t) { var e = F(t.dtype, L(t.shape)); return this.makeOutput(e, t.shape, t.dtype) }, Ih.prototype.linspace = function(t, e, n) { return No(t, e, n) }, Ih.prototype.scatter = function(t, e, n, r, o, i, a, s, u, c) {
        var l = [r / o, o],
    ...
    Kt.registerBackend("cpu", function() { return new _h }, 1);
    for (var Rh = 0, kh = [{
                    ...
                    c = function(t, e, a, s, n, u) {
                        ...
                        if (m.length + g.length === 0)
                            ...
                            var i = function(t) {
                                var e = it(t, c, l),
                                    n = e.slice(-f);
                                m.forEach(function(t) { return n[t] = 0 });
                                var r = ot(n, f, d),
                                    o = e.slice(-p);
                                g.forEach(function(t) { return o[t] = 0 });
                                var i = ot(o, p, v);
                                h[t] = u(a[r], s[i])
                            };
                        ...
                        return [h, r]
                    }(o.shape, i.shape, s, u, o.dtype, function(t, e) { var n = t - e; return n * n }),
                    l = c[0],
                    h = c[1];
    ...
    for (var Fh = 0, Mh = [{ kernelName: "Square", gradFunc: function(t, e) { var n = e[0]; return { x: function() { return t.mul(n.toFloat().mul(2)) } } } }, {
            kernelName: Fs,
            gradFunc: function(t, e) {
                var n = e[0],
                    r = e[1],
                    o = kn(2);
                return { a: function() { return Yu(t, Yu(o, tc(n, r))) }, b: function() { return Yu(t, Yu(o, tc(r, n))) } }
            }
    ...
    var Xh = (Qh.getInstance = function() { return null == Qh.instance && (Qh.instance = new Qh), Qh.instance }, Qh.registerSaveRouter = function(t) { Qh.getInstance().saveRouters.push(t) }, Qh.registerLoadRouter = function(t) { Qh.getInstance().loadRouters.push(t) }, Qh.getSaveHandlers = function(t) { return Qh.getHandlers(t, "save") }, Qh.getLoadHandlers = function(t, e) { return Qh.getHandlers(t, "load", e) }, Qh.getHandlers = function(n, t, r) {
        ...
        Yh = "://",
        $h = (Jh.getInstance = function() { return null == Jh.instance && (Jh.instance = new Jh), Jh.instance }, Jh.registerManager = function(t, e) {
            P(null != t, function() { return "scheme must not be undefined or null." }), t.endsWith(Yh) && (t = t.slice(0, t.indexOf(Yh))), P(0 < t.length, function() { return "scheme must not be an empty string." });
        ...
        }, Jh.getManager = function(t) { var e = this.getInstance().managers[t]; if (null == e) throw new Error("Cannot find model manager for scheme '" + t + "'"); return e }, Jh.getSchemes = function() { return Object.keys(this.getInstance().managers) }, Jh);
    ...
    function af(t) { return _().getBool("IS_BROWSER") && !Array.isArray(t) && t.startsWith(sf.URL_SCHEME) ? (e = t.slice(sf.URL_SCHEME.length), new sf(e)) : null; var e }
    var sf = (uf.prototype.save = function(e) { return y(this, void 0, void 0, function() { return R(this, function(t) { if (e.modelTopology instanceof ArrayBuffer) throw new Error("BrowserLocalStorage.save() does not support saving model topology in binary formats yet."); return [2, this.databaseAction(this.modelPath, e)] }) }) }, uf.prototype.load = function() { return y(this, void 0, void 0, function() { return R(this, function(t) { return [2, this.databaseAction(this.modelPath)] }) }) }, uf.prototype.databaseAction = function(t, h) {
        var f = this;
        return new Promise(function(u, c) {
            var l = f.indexedDB.open("tensorflowjs", 1);
            l.onupgradeneeded = function() { return of(l) }, l.onsuccess = function() {
                var r = l.result;
                if (null == h) {
        ...
        return y(this, void 0, void 0, function() {
            ...
            return R(this, function(t) {
                return [2, new Promise(function(i, n) {
                    ...
                    r.onupgradeneeded = function() { return of(r) }, r.onsuccess = function() {
                        var e = r.result,
        ...
        return y(this, void 0, void 0, function() {
            ...
            return R(this, function(t) {
                ...
                return u = (e = u).startsWith(sf.URL_SCHEME) ? e.slice(sf.URL_SCHEME.length) : e, [2, new Promise(function(a, s) {
                    ...
                    e.onupgradeneeded = function() { return of(e) }, e.onsuccess = function() {
                        var n, r = e.result,
    ...
    function lf() { this.indexedDB = rf() }
    if (_().getBool("IS_BROWSER")) try { $h.registerManager(sf.URL_SCHEME, new cf) } catch (r) {}
    var hf = "/",
    ...
    function bf(t) { return _().getBool("IS_BROWSER") && !Array.isArray(t) && t.startsWith(wf.URL_SCHEME) ? (e = t.slice(wf.URL_SCHEME.length), new wf(e)) : null; var e }
    ...
    var Ef = (_f.prototype.listModels = function() { return y(this, void 0, void 0, function() { var e, n, r, o, i, a; return R(this, function(t) { for (e = {}, n = ff + hf, r = hf + pf, o = 0; o < this.LS.length; ++o)(i = this.LS.key(o)).startsWith(n) && i.endsWith(r) && (a = xf(i), e[a] = JSON.parse(this.LS.getItem(i))); return [2, e] }) }) }, _f.prototype.removeModel = function(o) { return y(this, void 0, void 0, function() { var n, r; return R(this, function(t) { var e; if (o = (e = o).startsWith(wf.URL_SCHEME) ? e.slice(wf.URL_SCHEME.length) : e, n = yf(o), null == this.LS.getItem(n.info)) throw new Error("Cannot find model at path '" + o + "'"); return r = JSON.parse(this.LS.getItem(n.info)), this.LS.removeItem(n.info), this.LS.removeItem(n.topology), this.LS.removeItem(n.weightSpecs), this.LS.removeItem(n.weightData), [2, r] }) }) }, _f);

    function _f() { P(_().getBool("IS_BROWSER"), function() { return "Current environment is not a web browser" }), P("undefined" == typeof window || void 0 !== window.localStorage, function() { return "Current browser does not appear to support localStorage" }), this.LS = window.localStorage }
    if (_().getBool("IS_BROWSER")) try { $h.registerManager(wf.URL_SCHEME, new Ef) } catch (r) {}

    function If(t) { return new Promise(function(t) { return setTimeout(t) }).then(t) }
    var Rf = (Df.prototype.save = function(s) {
        ...
        kf = (Sf.prototype.load = function() {
                    ...
                    return r = this.files[0], h = this.files.slice(1), [2, new Promise(function(c, l) {
                        ...
                        t.onload = function(t) {
                            ...
                            if (null != i) {
                                ...
                                if (null != e) {
                                    var n;
                                    try { n = f.checkManifestAndWeightFiles(e, h) } catch (t) { return void l(t) }
                                    var a = [],
                                        s = [],
                                        u = [];
            ...
            for (var r = [], o = n.map(function(t) { return jh(t.name) }), i = {}, e = 0, a = t; e < a.length; e++) a[e].paths.forEach(function(t) {
                var e = jh(t);
        ...
        return function(p, o, d) {
            return void 0 === o && (o = ""), y(t, void 0, void 0, function() {
                ...
                return R(this, function(t) {
                    switch (t.label) {
                        case 0:
                            if (a = p.map(function() { return !1 }), c = {}, s = null != d ? d.map(function() { return !1 }) : [], u = [], p.forEach(function(t, o) {
                                    var i = 0;
                        ...
                        case 1:
                            return l = t.sent(), h = {}, f = 0, n.forEach(function(t) {
                                ...
                                c[t].forEach(function(t) { var e = Vh(o.slice(t.groupOffset, t.groupOffset + t.sizeBytes), [t.manifestEntry]); for (var n in e) h[n] = e[n] }), f += e
                            }), [2, h]
                    }
                })
            })
    ...
    Xh.registerSaveRouter(function(t) { return _().getBool("IS_BROWSER") && !Array.isArray(t) && t.startsWith(Rf.URL_SCHEME) ? (void 0 === (e = t.slice(Rf.URL_SCHEME.length)) && (e = "model"), new Rf(e)) : null; var e });
            ...
            return R(this, function(t) {
                switch (t.label) {
                    case 0:
                        ...
                        return p = [], v.forEach(function(t) { t.paths.forEach(function(t) { p.push(u + t + s) }) }), [4, Tf(p, { requestInit: this.requestInit, fetchFunc: this.fetch, onProgress: this.onProgress })];
                    case 1:
    ...
    var Lf = (Uf.prototype.load = function() { return y(this, void 0, void 0, function() { return R(this, function(t) { return [2, this.modelArtifacts] }) }) }, Uf),
    ...
    function Uf(t) { this.modelArtifacts = t }
    var Vf, Gf = Object.freeze({
            browserFiles: function(t) { return new kf(t) },
            browserHTTPRequest: function(t, e) { return Bf(t, e) },
                                                    ...
                                                    return R(this, function(t) {
                                                        switch (t.label) {
                                                            case 0:
                                                                return [4, c.bytes()];
                                                            case 1:
                                                                for (e = t.sent(), n = e.reduce(function(t, e) { return t + e.length }, 0) + Uh * e.length, r = new Uint8Array(n), i = o = 0; i < e.length; i++) a = e[i], s = new Uint8Array(new Uint32Array([a.length]).buffer), r.set(s, o), o += Uh, r.set(a, o), o += a.length;
                                                                return u(r), [2]
                                                        }
                                                    })
                                                })
            ...
            fromMemory: function(t, e, n, r) { return 1 === arguments.length ? null != t.modelTopology || null != t.weightSpecs ? new Lf(t) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Lf({ modelTopology: t })) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new Lf({ modelTopology: t, weightSpecs: e, weightData: n, trainingConfig: r })) },
            getLoadHandlers: function(t, e) { return Xh.getLoadHandlers(t, e) },
            getModelArtifactsInfoForJSON: Kh,
            getSaveHandlers: function(t) { return Xh.getSaveHandlers(t) },
            http: Bf,
            isHTTPScheme: Of,
            loadWeights: function(e, n, r, o) { return void 0 === n && (n = ""), y(this, void 0, void 0, function() { return R(this, function(t) { return [2, Nf(function(t) { return Tf(t, { requestInit: o }) })(e, n, r)] }) }) },
            registerLoadRouter: function(t) { return Xh.registerLoadRouter(t) },
            registerSaveRouter: function(t) { return Xh.registerSaveRouter(t) },
            weightsLoaderFactory: Nf,
            withSaveHandler: function(t) { return new Wf(t) },
            copyModel: function(e, n) { return y(this, void 0, void 0, function() { return R(this, function(t) { return [2, tf(e, n, !1)] }) }) },
            listModels: function() {
                return y(this, void 0, void 0, function() {
                    var e, n, r, o, i, a, s;
                    return R(this, function(t) {
            ...
            moveModel: function(e, n) { return y(this, void 0, void 0, function() { return R(this, function(t) { return [2, tf(e, n, !0)] }) }) },
            removeModel: function(n) { return y(this, void 0, void 0, function() { var e; return R(this, function(t) { return e = Zh(n), [2, $h.getManager(e.scheme).removeModel(e.path)] }) }) }
        }),
        Hf = wn({
    ...
    function np(t, e, n) { return !isFinite(t) && !isFinite(e) || !(isNaN(t) || isNaN(e) || Math.abs(t - e) > n) }
    var rp, op = Object.freeze({
            TEST_EPSILON_FLOAT16: .1,
            expectArraysClose: function(t, e, n) { return null == n && (n = tp()), ep(t, e, function(t, e) { return np(t, e, n) }) },
            testEpsilon: tp,
            expectPromiseToFail: function(t, e) { t().then(function() { return e.fail() }, function() { return e() }) },
            expectArraysEqual: function(t, e) { var n = "string" == typeof e || "number" == typeof e || "boolean" == typeof e ? [e] : e; return G(t) || G(t[0]) || G(e) || G(e[0]) ? ep(t, n, function(t, e) { return t == e }) : ep(t, e, function(t, e) { return np(t, e, 0) }) },
            expectNumbersClose: function(t, e, n) { if (null == n && (n = tp()), !np(t, e, n)) throw new Error("Numbers differ: actual === " + t + ", expected === " + e) },
        ...
        }, Object.defineProperty(sp.prototype, "iterations", { get: function() { return null == this.iterations_ && (this.iterations_ = 0), this.iterations_ }, enumerable: !0, configurable: !0 }), sp.prototype.incrementIterations = function() { this.iterations_ = this.iterations + 1 }, sp.prototype.computeGradients = function(t, e) { return oo(t, e) }, sp.prototype.dispose = function() { null != this.iterations_ && rn(this.iterations_) }, sp.prototype.saveIterations = function() { return y(this, void 0, void 0, function() { return R(this, function(t) { return null == this.iterations_ && (this.iterations_ = 0), [2, { name: "iter", tensor: kn(this.iterations_, "int32") }] }) }) }, sp.prototype.getWeights = function() { return y(this, void 0, void 0, function() { return R(this, function(t) { throw new Error("getWeights() is not implemented for this optimizer yet.") }) }) }, sp.prototype.setWeights = function(t) { return y(this, void 0, void 0, function() { return R(this, function(t) { throw new Error("setWeights() is not implemented for this optimizer class " + this.getClassName()) }) }) }, sp.prototype.extractIterations = function(n) {
            return y(this, void 0, void 0, function() {
                var e;
                return R(this, function(t) {
                    switch (t.label) {
    ...
    Object.defineProperty(ap, Symbol.hasInstance, { value: function(t) { return null != t.minimize && null != t.computeGradients && null != t.applyGradients } });
    var up, cp = (t(lp, up = ap), lp.prototype.applyGradients = function(n) {
        ...
        (Array.isArray(n) ? n.map(function(t) { return t.name }) : Object.keys(n)).forEach(function(t, e) {
            ...
            null == u.accumulatedGrads[e] && (u.accumulatedGrads[e] = { originalName: t + "/accum_grad", variable: nn(function() { return Un(o).variable(!1) }) }), null == u.accumulatedUpdates[e] && (u.accumulatedUpdates[e] = { originalName: t + "/accum_var", variable: nn(function() { return Un(o).variable(!1) }) });
    ...
    }, lp.prototype.dispose = function() { null != this.accumulatedUpdates && (rn(this.accumulatedGrads.map(function(t) { return t.variable })), rn(this.accumulatedUpdates.map(function(t) { return t.variable }))) }, lp.prototype.getWeights = function() {
        return y(this, void 0, void 0, function() {
            var e;
            return R(this, function(t) {
                switch (t.label) {
    ...
    }, lp.prototype.getConfig = function() { return { learningRate: this.learningRate, rho: this.rho, epsilon: this.epsilon } }, lp.fromConfig = function(t, e) { return new t(e.learningRate, e.rho, e.epsilon) }, lp.className = "Adadelta", lp);
    ...
    var hp, fp = (t(pp, hp = ap), pp.prototype.applyGradients = function(i) {
        ...
        (Array.isArray(i) ? i.map(function(t) { return t.name }) : Object.keys(i)).forEach(function(t, e) {
            ...
            null == a.accumulatedGrads[e] && (a.accumulatedGrads[e] = { originalName: t + "/accumulator", variable: nn(function() { return Bn(n.shape, a.initialAccumulatorValue).variable(!1) }) });
    ...
    }, pp.prototype.dispose = function() { null != this.accumulatedGrads && rn(this.accumulatedGrads.map(function(t) { return t.variable })) }, pp.prototype.getWeights = function() {
        return y(this, void 0, void 0, function() {
            return R(this, function(t) {
                switch (t.label) {
                    case 0:
    ...
    }, pp.prototype.getConfig = function() { return { learningRate: this.learningRate, initialAccumulatorValue: this.initialAccumulatorValue } }, pp.fromConfig = function(t, e) { return new t(e.learningRate, e.initialAccumulatorValue) }, pp.className = "Adagrad", pp);
    ...
    var dp, vp = (t(mp, dp = ap), mp.prototype.applyGradients = function(p) {
        ...
        nn(function() {
            ...
            t.forEach(function(t, e) {
                var n = Kt.registeredVariables[t];
                null == d.accumulatedFirstMoment[e] && (d.accumulatedFirstMoment[e] = { originalName: t + "/m", variable: nn(function() { return Un(n).variable(!1) }) }), null == d.accumulatedSecondMoment[e] && (d.accumulatedSecondMoment[e] = { originalName: t + "/v", variable: nn(function() { return Un(n).variable(!1) }) });
    ...
    }, mp.prototype.dispose = function() { this.accBeta1.dispose(), this.accBeta2.dispose(), null != this.accumulatedFirstMoment && rn(this.accumulatedFirstMoment.map(function(t) { return t.variable })), null != this.accumulatedSecondMoment && rn(this.accumulatedSecondMoment.map(function(t) { return t.variable })) }, mp.prototype.getWeights = function() {
        return y(this, void 0, void 0, function() {
            var e;
            return R(this, function(t) {
                switch (t.label) {
    ...
    }, mp.prototype.getConfig = function() { return { learningRate: this.learningRate, beta1: this.beta1, beta2: this.beta2, epsilon: this.epsilon } }, mp.fromConfig = function(t, e) { return new t(e.learningRate, e.beta1, e.beta2, e.epsilon) }, mp.className = "Adam", mp);
    ...
    }, Cp.prototype.setLearningRate = function(t) { this.learningRate = t, null != this.c && this.c.dispose(), this.c = on(kn(-t)) }, Cp.prototype.dispose = function() { this.c.dispose() }, Cp.prototype.getWeights = function() {
        return y(this, void 0, void 0, function() {
            return R(this, function(t) {
                switch (t.label) {
                    case 0:
    ...
    }, Cp.prototype.getConfig = function() { return { learningRate: this.learningRate } }, Cp.fromConfig = function(t, e) { return new t(e.learningRate) }, Cp.className = "SGD", Cp);
    ...
    var Ep, _p = (t(Ip, Ep = wp), Ip.prototype.applyGradients = function(i) {
        ...
        (Array.isArray(i) ? i.map(function(t) { return t.name }) : Object.keys(i)).forEach(function(t, e) {
            var n = Kt.registeredVariables[t];
            null == a.accumulations[e] && (a.accumulations[e] = { originalName: t + "/momentum", variable: nn(function() { return Un(n).variable(!1) }) });
    ...
    }, Ip.prototype.dispose = function() { this.m.dispose(), null != this.accumulations && rn(this.accumulations.map(function(t) { return t.variable })) }, Ip.prototype.setMomentum = function(t) { this.momentum = t }, Ip.prototype.getWeights = function() {
        return y(this, void 0, void 0, function() {
            return R(this, function(t) {
                switch (t.label) {
                    case 0:
    ...
    }, Ip.prototype.getConfig = function() { return { learningRate: this.learningRate, momentum: this.momentum, useNesterov: this.useNesterov } }, Ip.fromConfig = function(t, e) { return new t(e.learningRate, e.momentum, e.useNesterov) }, Ip.className = "Momentum", Ip);
    ...
    var Rp, kp = (t(Sp, Rp = ap), Sp.prototype.applyGradients = function(e) {
        ...
        (Array.isArray(e) ? e.map(function(t) { return t.name }) : Object.keys(e)).forEach(function(t, a) {
            ...
            null == h.accumulatedMeanSquares[a] && (h.accumulatedMeanSquares[a] = { originalName: t + "/rms", variable: nn(function() { return Un(s).variable(!1) }) }), null == h.accumulatedMoments[a] && (h.accumulatedMoments[a] = { originalName: t + "/momentum", variable: nn(function() { return Un(s).variable(!1) }) }), null == h.accumulatedMeanGrads[a] && h.centered && (h.accumulatedMeanGrads[a] = { originalName: t + "/mg", variable: nn(function() { return Un(s).variable(!1) }) });
    ...
    }, Sp.prototype.dispose = function() { null != this.accumulatedMeanSquares && rn(this.accumulatedMeanSquares.map(function(t) { return t.variable })), null != this.accumulatedMeanGrads && this.centered && rn(this.accumulatedMeanGrads.map(function(t) { return t.variable })), null != this.accumulatedMoments && rn(this.accumulatedMoments.map(function(t) { return t.variable })) }, Sp.prototype.getWeights = function() {
        return y(this, void 0, void 0, function() {
            var e;
            return R(this, function(t) {
                switch (t.label) {
    ...
    }, Sp.prototype.getConfig = function() { return { learningRate: this.learningRate, decay: this.decay, momentum: this.momentum, epsilon: this.epsilon, centered: this.centered } }, Sp.fromConfig = function(t, e) { return new t(e.learningRate, e.decay, e.momentum, e.epsilon, e.centered) }, Sp.className = "RMSProp", Sp);
    ...
    function Np() {}
    bt.prototype.squaredDifference = function(t) { return Ms(this, t) }, gt = bh;
    var Fp = Object.freeze({
        ...
        avgPool: Hc,
        avgPool3d: Kc,
        backend: function() { return Kt.backend },
        backend_util: Fo,
        basicLSTMCell: bl,
        batchNorm: Ru,
        batchNorm2d: ku,
        ...
        dispose: rn,
        disposeVariables: function() { Kt.disposeVariables() },
        div: Wu,
        divNoNan: zu,
        divStrict: Uu,
        dot: Mc,
        ...
        fft: Rl,
        fill: Bn,
        findBackend: function(t) { return Kt.findBackend(t) },
        findBackendFactory: function(t) { return Kt.findBackendFactory(t) },
        floor: Ys,
        floorDiv: Vu,
        frame: Ul,
        fused: xh,
        ...
        gatherND: Nl,
        gather_util: Hr,
        getBackend: function() { return Kt.backendName },
        getGradient: l,
        getKernel: g,
            ...
            return P(K(i), function() { return "The f passed in grad(f) must be a function" }),
                function(t, e) {
                    ...
                    return Kt.tidy(function() {
                        var t = Kt.gradients(function() { return i(r) }, [r], o),
                            e = t.value,
                            n = t.grads;
        ...
        grads: function(i) {
            return P(K(i), function() { return "The f passed in grads(f) must be a function" }),
                function(t, e) {
                    ...
                    return Kt.tidy(function() {
                        var t = Kt.gradients(function() { return i.apply(void 0, r) }, r, o),
                            e = t.value,
                            n = t.grads;
        ...
        maximumStrict: Hu,
        mean: al,
        memory: function() { return Kt.memory() },
        min: sl,
        minimum: qu,
        minimumStrict: ju,
        mod: Ku,
        ...
        multinomial: br,
        neg: Zs,
        nextFrame: function() { return new Promise(function(t) { return Tp(function() { return t() }) }) },
        norm: xl,
        notEqual: fc,
        notEqualStrict: pc,
        oneHot: wr,
        ...
        print: lr,
        prod: ll,
        profile: function(t) { return Kt.profile(t) },
        rand: kr,
        randomGamma: Dr,
        randomNormal: Sr,
        randomUniform: Ar,
        range: Wn,
        ready: function() { return Kt.ready() },
        real: En,
        reciprocal: tu,
        registerBackend: function(t, e, n) { return void 0 === n && (n = 1), Kt.registerBackend(t, e, n) },
        registerGradient: h,
        registerKernel: s,
        relu: dl,
        relu6: vl,
        removeBackend: function(t) { Kt.removeBackend(t) },
        reshape: Tr,
        reverse: Pc,
        reverse1d: Bc,
        reverse2d: Lc,
        ...
        separableConv2d: Ac,
        serialization: Zf,
        setBackend: function(t) { return Kt.setBackend(t) },
        ...
        tidy: nn,
        tile: Or,
        time: function(t) { return Kt.time(t) },
        topk: _l,
        train: Ap,
        transpose: gl,
        truncatedNormal: Pr,
        ...
        valueAndGrad: function(i) {
            return P(K(i), function() { return "The f passed in valueAndGrad(f) must be a function" }),
                function(t, e) {
                    P(t instanceof bt, function() { return "The x passed in valueAndGrad(f)(x) must be a tensor" }), P(null == e || e instanceof bt, function() { return "The dy passed in valueAndGrad(f)(x, dy) must be a tensor" });
                    var n = Kt.gradients(function() { return i(t) }, [t], e),
                        r = n.grads,
                        o = n.value;
    ...
    var Op = function(t, e) {
        return (Op = Object.setPrototypeOf || { __proto__: [] }
            instanceof Array && function(t, e) { t.__proto__ = e } || function(t, e) { for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]) })(t, e)
    };
    ...
    var Up = (Object.defineProperty(Vp.prototype, "width", { get: function() { return this._width }, enumerable: !0, configurable: !0 }), Object.defineProperty(Vp.prototype, "height", { get: function() { return this._height }, enumerable: !0, configurable: !0 }), Vp.prototype.reverse = function() { return new Vp(1 / this.width, 1 / this.height) }, Vp);
    ...
    function ed(t) { return td(t) && 0 <= t && t <= 1 }
    var nd = Object.freeze({ __proto__: null, isTensor: Gp, isTensor1D: function(t) { return Gp(t, 1) }, isTensor2D: Hp, isTensor3D: qp, isTensor4D: jp, isFloat: Kp, isEven: Xp, round: Yp, isDimensions: $p, computeReshapedDimensions: Jp, getCenterPoint: Qp, range: Zp, isValidNumber: td, isValidProbablitiy: ed }),
    ...
    function od(t, e) { this._x = t, this._y = e }
    ...
    }, ad.prototype.pad = function(t, e) { var n = [this.x - t / 2, this.y - e / 2, this.width + t, this.height + e]; return new ad({ x: n[0], y: n[1], width: n[2], height: n[3] }) }, ad.prototype.clipAtImageBorders = function(t, e) {
        var n = this.x,
            r = this.y,
            o = this.right,
            i = this.bottom,
    ...
    }, ad.prototype.calibrate = function(t) { return new ad({ left: this.left + t.left * this.width, top: this.top + t.top * this.height, right: this.right + t.right * this.width, bottom: this.bottom + t.bottom * this.height }).toSquare().round() }, ad);
    ...
    function cd(t, e, n, r, o) { return void 0 === o && (o = !1), sd.call(this, { left: t, top: e, right: n, bottom: r }, o) || this }
    ...
    function hd(t, e, n, r, o) { this._imageDims = new Up(o.width, o.height), this._score = t, this._classScore = e, this._className = n, this._box = new id(r).rescale(this._imageDims) }
    var fd, pd = (Pp(dd, fd = ld), dd.prototype.forSize = function(t, e) { var n = fd.prototype.forSize.call(this, t, e); return new dd(n.score, n.relativeBox, n.imageDims) }, dd);
    ...
    function xd(l, h) {
        return void 0 === h && (h = !1), nn(function() {
            ...
            function r(t) { var e = l.shape.slice(); return e[a] = t, Bn(e, 0) }
            var o = Math.abs(e - n),
    ...
    }, Id.prototype.alignMinBbox = function(t) { var e = md(this.positions); return e.pad(e.width * t, e.height * t) }, Id.prototype.getRefPointsForAlignment = function() { throw new Error("getRefPointsForAlignment not implemented by base class") }, Id);

    function Id(t, e, n) {
        void 0 === n && (n = new rd(0, 0));
        var r = e.width,
            o = e.height;
        this._imgDims = new Up(r, o), this._shift = n, this._positions = t.map(function(t) { return t.mul(new rd(r, o)).add(n) })
    }
    var Rd, kd = (Pp(Sd, Rd = _d), Sd.prototype.getRefPointsForAlignment = function() { var t = this.positions; return [t[0], t[1], Qp([t[3], t[4]])] }, Sd);

    function Sd() { return null !== Rd && Rd.apply(this, arguments) || this }
    var Dd, Ad = (Pp(Td, Dd = _d), Td.prototype.getJawOutline = function() { return this.positions.slice(0, 17) }, Td.prototype.getLeftEyeBrow = function() { return this.positions.slice(17, 22) }, Td.prototype.getRightEyeBrow = function() { return this.positions.slice(22, 27) }, Td.prototype.getNose = function() { return this.positions.slice(27, 36) }, Td.prototype.getLeftEye = function() { return this.positions.slice(36, 42) }, Td.prototype.getRightEye = function() { return this.positions.slice(42, 48) }, Td.prototype.getMouth = function() { return this.positions.slice(48, 68) }, Td.prototype.getRefPointsForAlignment = function() { return [this.getLeftEye(), this.getRightEye(), this.getMouth()].map(Qp) }, Td);

    function Td() { return null !== Dd && Dd.apply(this, arguments) || this }
    var Nd = (Object.defineProperty(Fd.prototype, "label", { get: function() { return this._label }, enumerable: !0, configurable: !0 }), Object.defineProperty(Fd.prototype, "distance", { get: function() { return this._distance }, enumerable: !0, configurable: !0 }), Fd.prototype.toString = function(t) { return void 0 === t && (t = !0), this.label + (t ? " (" + Yp(this.distance) + ")" : "") }, Fd);

    function Fd(t, e) { this._label = t, this._distance = e }
    var Md, Od = (Pp(Pd, Md = id), Pd.assertIsValidLabeledBox = function(t, e) { if (id.assertIsValidBox(t, e), !td(t.label)) throw new Error(e + " - expected property label (" + t.label + ") to be a number") }, Object.defineProperty(Pd.prototype, "label", { get: function() { return this._label }, enumerable: !0, configurable: !0 }), Pd);

    function Pd(t, e) { var n = Md.call(this, t) || this; return n._label = e, n }
    var Bd = (Object.defineProperty(Ld.prototype, "label", { get: function() { return this._label }, enumerable: !0, configurable: !0 }), Object.defineProperty(Ld.prototype, "descriptors", { get: function() { return this._descriptors }, enumerable: !0, configurable: !0 }), Ld.prototype.toJSON = function() { return { label: this.label, descriptors: this.descriptors.map(function(t) { return Array.from(t) }) } }, Ld.fromJSON = function(t) { var e = t.descriptors.map(function(t) { return new Float32Array(t) }); return new Ld(t.label, e) }, Ld);
    ...
    function Kd() {
        var t = global.Canvas || global.HTMLCanvasElement,
            ...
            r = jd();
        return Bp({ Canvas: t || function() {}, CanvasRenderingContext2D: global.CanvasRenderingContext2D || function() {}, Image: e || function() {}, ImageData: global.ImageData || function() {}, Video: global.HTMLVideoElement || function() {}, createCanvasElement: function() { if (t) return new t; throw new Error("createCanvasElement - missing Canvas implementation for nodejs environment") }, createImageElement: function() { if (e) return new e; throw new Error("createImageElement - missing Image implementation for nodejs environment") }, fetch: n }, r)
    }
    ...
    var Qd, Zd, tv = {
        ...
        monkeyPatch: function(t) {
            ...
            zd.Canvas = n, zd.Image = o, zd.createCanvasElement = t.createCanvasElement || function() { return new n }, zd.createImageElement = t.createImageElement || function() { return new o }, zd.ImageData = t.ImageData || zd.ImageData, zd.Video = t.Video || zd.Video, zd.fetch = t.fetch || zd.fetch, zd.readFile = t.readFile || zd.readFile
        },
        isBrowser: Xd,
        isNodejs: Yd
    };
    ...
    var rv = function(t) {
        ...
        ov = (iv.prototype.measureWidth = function(e) { var t = this.options.padding; return this.text.map(function(t) { return e.measureText(t).width }).reduce(function(t, e) { return t < e ? e : t }, 0) + 2 * t }, iv.prototype.measureHeight = function() {
            var t = this.options,
                e = t.fontSize,
                n = t.padding;
    ...
    function iv(t, e, n) { void 0 === n && (n = {}), this.text = "string" == typeof t ? [t] : t instanceof iv ? t.text : t, this.anchor = e, this.options = new rv(n) }
    var av = function(t) {
            void 0 === t && (t = {});
            var e = t.boxColor,
                n = t.lineWidth,
    ...
    var yv = (Object.defineProperty(xv.prototype, "imageTensors", { get: function() { return this._imageTensors }, enumerable: !0, configurable: !0 }), Object.defineProperty(xv.prototype, "canvases", { get: function() { return this._canvases }, enumerable: !0, configurable: !0 }), Object.defineProperty(xv.prototype, "isBatchInput", { get: function() { return 1 < this.batchSize || this._treatAsBatchInput }, enumerable: !0, configurable: !0 }), Object.defineProperty(xv.prototype, "batchSize", { get: function() { return this._batchSize }, enumerable: !0, configurable: !0 }), Object.defineProperty(xv.prototype, "inputDimensions", { get: function() { return this._inputDimensions }, enumerable: !0, configurable: !0 }), Object.defineProperty(xv.prototype, "inputSize", { get: function() { return this._inputSize }, enumerable: !0, configurable: !0 }), Object.defineProperty(xv.prototype, "reshapedInputDimensions", { get: function() { var n = this; return Zp(this.batchSize, 0, 1).map(function(t, e) { return n.getReshapedInputDimensions(e) }) }, enumerable: !0, configurable: !0 }), xv.prototype.getInput = function(t) { return this.canvases[t] || this.imageTensors[t] }, xv.prototype.getInputDimensions = function(t) { return this._inputDimensions[t] }, xv.prototype.getInputHeight = function(t) { return this._inputDimensions[t][0] }, xv.prototype.getInputWidth = function(t) { return this._inputDimensions[t][1] }, xv.prototype.getReshapedInputDimensions = function(t) { if ("number" != typeof this.inputSize) throw new Error("getReshapedInputDimensions - inputSize not set, toBatchTensor has not been called yet"); return Jp({ width: this.getInputWidth(t), height: this.getInputHeight(t) }, this.inputSize) }, xv.prototype.toBatchTensor = function(r, o) { var i = this; return void 0 === o && (o = !0), this._inputSize = r, nn(function() { var t = Zp(i.batchSize, 0, 1).map(function(t) { var e = i.getInput(t); if (e instanceof bt) { var n = jp(e) ? e : e.expandDims(); return (n = xd(n, o)).shape[1] === r && n.shape[2] === r || (n = vh.resizeBilinear(n, [r, r])), n.as3D(r, r, 3) } if (e instanceof tv.getEnv().Canvas) return Kf.fromPixels(gv(e, r, o)); throw new Error("toBatchTensor - at batchIdx " + t + ", expected input to be instanceof tf.Tensor or instanceof HTMLCanvasElement, instead have " + e) }); return Mr(t.map(function(t) { return t.toFloat() })).as4D(i.batchSize, r, r, 3) }) }, xv);
    ...
    function xv(t, e) {
        ...
        this._treatAsBatchInput = e, this._batchSize = t.length, t.forEach(function(t, e) {
            ...
            if (jp(t)) { var n = t.shape[0]; if (1 !== n) throw new Error("NetInput - tf.Tensor4D with batchSize " + n + " passed, but not supported in input array"); return o._imageTensors[e] = t, void(o._inputDimensions[e] = t.shape.slice(1)) }
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 4:
                        n = i, t.label = 5;
                    case 5:
                        return a = nv(n), [2, u.map(function(t) { return t instanceof pd ? t.forSize(n.width, n.height).box.floor() : t }).map(function(t) { return t.clipAtImageBorders(n.width, n.height) }).map(function(t) {
                            var e = t.x,
                                n = t.y,
                                r = t.width,
                                o = t.height,
            ...
            return Wp(this, function(t) {
                ...
                return [2, nn(function() {
                    var t = u.shape.slice(jp(u) ? 1 : 0),
                        ...
                        a = t[1],
                        s = t[2];
                    return e.map(function(t) { return t instanceof pd ? t.forSize(a, i).box : t }).map(function(t) { return t.clipAtImageBorders(a, i) }).map(function(t) {
                        var e = t.x,
                            n = t.y,
                            r = t.width,
                            o = t.height;
    ...
    }, Sv.prototype.serializeParams = function() { return new Float32Array(this.getParamList().map(function(t) { var e = t.tensor; return Array.from(e.dataSync()) }).reduce(function(t, e) { return t.concat(e) })) }, Sv.prototype.load = function(e) {
        return Lp(this, void 0, void 0, function() {
            return Wp(this, function(t) {
                switch (t.label) {
                    case 0:
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    case 0:
                        ...
                        return e = tv.getEnv().readFile, n = Iv(h, this.getDefaultModelName()), r = n.manifestUri, o = n.modelBaseUri, i = function(t) { return Promise.all(t.map(function(t) { return e(t).then(function(t) { return t.buffer }) })) }, a = Gf.weightsLoaderFactory(i), c = (u = JSON).parse, [4, e(r)];
                    case 1:
    ...
    var Pv = function(t, e, n) { this.depthwise_filter = t, this.pointwise_filter = e, this.bias = n };
    ...
    }, jv.prototype.getDefaultModelName = function() { return "face_feature_extractor_model" }, jv.prototype.extractParamsFromWeigthMap = function(t) {
        return function(t) {
            var e = [],
    ...
    var Yv, $v = (Pp(Jv, Yv = kv), Object.defineProperty(Jv.prototype, "faceFeatureExtractor", { get: function() { return this._faceFeatureExtractor }, enumerable: !0, configurable: !0 }), Jv.prototype.runNet = function(e) {
        var n = this,
            r = this.params;
        if (!r) throw new Error(this._name + " - load model before inference");
        return nn(function() { var t = e instanceof yv ? n.faceFeatureExtractor.forwardInput(e) : e; return Kv(t.as2D(t.shape[0], -1), r.fc) })
    }, Jv.prototype.dispose = function(t) { void 0 === t && (t = !0), this.faceFeatureExtractor.dispose(t), Yv.prototype.dispose.call(this, t) }, Jv.prototype.loadClassifierParams = function(t) {
    ...
    function Jv(t, e) { var n = Yv.call(this, t) || this; return n._faceFeatureExtractor = e, n }
    ...
    function tm(n) {
        ...
        Qv.forEach(function(t, e) { r[t] = n[e] })
    }
    var em, nm = (Pp(rm, em = $v), rm.prototype.forwardInput = function(t) { var e = this; return nn(function() { return so(e.runNet(t)) }) }, rm.prototype.forward = function(n) {
        return Lp(this, void 0, void 0, function() {
            var e;
            return Wp(this, function(t) {
                switch (t.label) {
        ...
        return Lp(this, void 0, void 0, function() {
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 3:
                        return r = t.sent(), n.dispose(), o = r.map(function(t) { return new Zv(t) }), [2, e.isBatchInput ? o : o[0]]
                }
            })
        })
    }, rm.prototype.getDefaultModelName = function() { return "face_expression_model" }, rm.prototype.getClassifierChannelsIn = function() { return 256 }, rm.prototype.getClassifierChannelsOut = function() { return 7 }, rm);
    ...
    function lm(t, e) { void 0 === e && (e = {}), this.faceLandmarks = t, this.options = new um(e) }
    var hm = Object.freeze({
        ...
        drawFaceExpressions: function(o, t, i, a) {
            void 0 === i && (i = .1), (Array.isArray(t) ? t : [t]).forEach(function(t) {
                ...
                new ov(n.map(function(t) { return t.expression + " (" + Yp(t.probability) + ")" }), r).draw(o)
            })
        },
        DrawBoxOptions: av,
        DrawBox: sv,
    ...
    function fm(t, e) {
        var n = [],
            ...
            f = {};
        Zp(e, 0, 1).forEach(function(t) { f["main_block_" + t] = l(128, "middle_flow/main_block_" + t) });
    ...
    function pm(t, e) {
        var n = [],
            ...
            c = {};
        Zp(e, 0, 1).forEach(function(t) { c["main_block_" + t] = s("middle_flow/main_block_" + t) });
    ...
    function vm(t, e, n) { void 0 === n && (n = !0); var r = n ? dl(t) : t; return r = Dv(r, e.separable_conv0, [1, 1]), r = Dv(dl(r), e.separable_conv1, [1, 1]), r = Gc(r, [3, 3], [2, 2], "same"), r = Ou(r, dm(t, e.expansion_conv, [2, 2])) }
    var mm, gm, ym = (Pp(xm, mm = kv), xm.prototype.forwardInput = function(n) {
        ...
        return nn(function() {
            ...
            return e = vm(e = vm(e, o.entry_flow.reduction_block_0, !1), o.entry_flow.reduction_block_1), Zp(r._numMainBlocks, 0, 1).forEach(function(t) { e = function(t, e) { var n = Dv(dl(t), e.separable_conv0, [1, 1]); return n = Dv(dl(n), e.separable_conv1, [1, 1]), n = Dv(dl(n), e.separable_conv2, [1, 1]), n = Ou(n, t) }(e, o.middle_flow["main_block_" + t]) }), e = vm(e, o.exit_flow.reduction_block), e = dl(Dv(e, o.exit_flow.separable_conv, [1, 1]))
        })
    ...
    }, xm.prototype.getDefaultModelName = function() { return "tiny_xception_model" }, xm.prototype.extractParamsFromWeigthMap = function(t) { return pm(t, this._numMainBlocks) }, xm.prototype.extractParams = function(t) { return fm(t, this._numMainBlocks) }, xm);

    function xm(t) { var e = mm.call(this, "TinyXception") || this; return e._numMainBlocks = t, e }(gm = c.Gender || (c.Gender = {})).FEMALE = "female", gm.MALE = "male";
    var bm, wm = (Pp(Cm, bm = kv), Object.defineProperty(Cm.prototype, "faceFeatureExtractor", { get: function() { return this._faceFeatureExtractor }, enumerable: !0, configurable: !0 }), Cm.prototype.runNet = function(n) {
        var r = this,
            o = this.params;
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 1:
                        return e = t.sent(), [4, this.forwardInput(e)];
                    case 2:
                        return n = t.sent(), r = Br(n.age), o = Br(n.gender), i = r.map(function(t, e) { return { ageTensor: t, genderTensor: o[e] } }), [4, Promise.all(i.map(function(t) {
                            var a = t.ageTensor,
                                s = t.genderTensor;
    ...
    }, Cm.prototype.getDefaultModelName = function() { return "age_gender_model" }, Cm.prototype.dispose = function(t) { void 0 === t && (t = !0), this.faceFeatureExtractor.dispose(t), bm.prototype.dispose.call(this, t) }, Cm.prototype.loadClassifierParams = function(t) {
        var e = this.extractClassifierParams(t),
            n = e.params,
            r = e.paramMappings;
        this._params = n, this._paramMappings = r
    ...
    function Cm(t) { void 0 === t && (t = new ym(2)); var e = bm.call(this, "AgeGenderNet") || this; return e._faceFeatureExtractor = t, e }
    var Em, _m = (Pp(Im, Em = $v), Im.prototype.postProcess = function(t, o, e) {
        ...
        return nn(function() {
            ...
            return t.mul(Bn([a, 136], o)).sub(Mr(Array.from(Array(a), function(t, e) { return n(function(t) { return r(t, function(t, e) { return t < e }) }(e), function(t) { return r(t, function(t, e) { return e < t }) }(e)) }))).div(Mr(Array.from(Array(a), function(t, e) { return n(i[e].width, i[e].height) })))
        })
    }, Im.prototype.forwardInput = function(e) { var n = this; return nn(function() { var t = n.runNet(e); return n.postProcess(t, e.inputSize, e.inputDimensions.map(function(t) { return { height: t[0], width: t[1] } })) }) }, Im.prototype.forward = function(n) {
        return Lp(this, void 0, void 0, function() {
            var e;
            return Wp(this, function(t) {
                switch (t.label) {
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    case 0:
                        return [4, bv(o)];
                    case 1:
                        return u = t.sent(), e = nn(function() { return Br(r.forwardInput(u)) }), [4, Promise.all(e.map(function(a, s) {
    ...
    }, Im.prototype.getClassifierChannelsOut = function() { return 136 }, Im);

    function Im() { return null !== Em && Em.apply(this, arguments) || this }
    var Rm, km = (Pp(Sm, Rm = _m), Sm.prototype.getDefaultModelName = function() { return "face_landmark_68_model" }, Sm.prototype.getClassifierChannelsIn = function() { return 256 }, Sm);

    function Sm(t) { return void 0 === t && (t = new qv), Rm.call(this, "FaceLandmark68Net", t) || this }
    var Dm, Am = (Pp(Tm, Dm = kv), Tm.prototype.forwardInput = function(e) { var n = this.params; if (!n) throw new Error("TinyFaceFeatureExtractor - load model before inference"); return nn(function() { var t = Av(yd(e.toBatchTensor(112, !0), [122.782, 117.001, 104.298]).div(kn(255)), n.dense0, !0); return t = Av(t = Av(t, n.dense1), n.dense2), t = Hc(t, [14, 14], [2, 2], "valid") }) }, Tm.prototype.forward = function(n) {
        return Lp(this, void 0, void 0, function() {
            var e;
            return Wp(this, function(t) {
                switch (t.label) {
    ...
    }, Tm.prototype.getDefaultModelName = function() { return "face_feature_extractor_tiny_model" }, Tm.prototype.extractParamsFromWeigthMap = function(t) {
        return function(t) {
            var e = [],
    ...
    function Tm() { return Dm.call(this, "TinyFaceFeatureExtractor") || this }
    var Nm, Fm = (Pp(Mm, Nm = _m), Mm.prototype.getDefaultModelName = function() { return "face_landmark_68_tiny_model" }, Mm.prototype.getClassifierChannelsIn = function() { return 128 }, Mm);

    function Mm(t) { return void 0 === t && (t = new Am), Nm.call(this, "FaceLandmark68TinyNet", t) || this }
    ...
    function Lm(t, e, n, r, o) {
        ...
        var i = e.conv,
            ...
            s = i.bias,
            u = Ec(t, a, n, o);
        return u = function(t, e) { return Ou(Yu(t, e.weights), e.biases) }(u = Ou(u, s), e.scale), r ? dl(u) : u
    }
    ...
    function Um(a, s) {
        function o(t, e, n, r) {
            var o = function(t, e, n) {
                    ...
                    return nn(function() { return gl(Tn(r, [e, o, n, n]), [2, 3, 1, 0]) })
                }(t, e, n),
                i = Sn(a(e));
            return s.push({ paramPath: r + "/filters" }, { paramPath: r + "/bias" }), { filters: o, bias: i }
        }
    ...
    var qm, jm = (Pp(Km, qm = kv), Km.prototype.forwardInput = function(n) {
    ...
    }, Km.prototype.getDefaultModelName = function() { return "face_recognition_model" }, Km.prototype.extractParamsFromWeigthMap = function(t) {
        return function(t) {
            var e = [],
                n = Vm(t, e),
        ...
        return function(t) {
            var e = zv(t),
                ...
                E = nn(function() { return gl(Dn(n(32768), [128, 256]), [1, 0]) });
    ...
    function eg(e, n, r) { return nn(function() { var t = Ec(e, n.filters, r, "same"); return t = Ou(t, n.batch_norm_offset), Gs(t, 0, 6) }) }
    ...
    function rg(t, e) {
        return nn(function() {
            ...
            if ([e.conv_1, e.conv_2, e.conv_3, e.conv_4, e.conv_5, e.conv_6, e.conv_7, e.conv_8, e.conv_9, e.conv_10, e.conv_11, e.conv_12, e.conv_13].forEach(function(t, e) {
                    ...
                    i = eg(i = function(e, n, r) { return nn(function() { var t = kc(e, n.filters, r, "same"); return t = Ru(t, n.batch_norm_mean, n.batch_norm_variance, n.batch_norm_offset, n.batch_norm_scale, ng), Gs(t, 0, 6) }) }(i, t.depthwise_conv, r), t.pointwise_conv, [1, 1]), 11 === n && (o = i)
    ...
    function ag(e, n) { return nn(function() { var t = e.shape[0]; return { boxPredictionEncoding: Tr(Nv(e, n.box_encoding_predictor), [t, -1, 1, 4]), classPrediction: Tr(Nv(e, n.class_predictor), [t, -1, 3]) } }) }
    var sg = (Object.defineProperty(ug.prototype, "minConfidence", { get: function() { return this._minConfidence }, enumerable: !0, configurable: !0 }), Object.defineProperty(ug.prototype, "maxResults", { get: function() { return this._maxResults }, enumerable: !0, configurable: !0 }), ug);
                    ...
                    case 2:
                        return h = p.apply(f, [t.sent()]), d = function(o, t, e, i, a) {
                            ...
                            return r.forEach(function(t) {
                                if (!(u.length >= s)) {
                                    for (var e = t.score, n = u.length - 1; 0 <= n; --n) { var r = og(o, t.boxIndex, u[n]); if (0 !== r && (t.score *= r <= i ? 1 : 0, t.score <= a)) break }
    ...
    }, hg.prototype.getDefaultModelName = function() { return "ssd_mobilenetv1_model" }, hg.prototype.extractParamsFromWeigthMap = function(t) { return tg(t) }, hg.prototype.extractParams = function(t) {
        return function(t) {
            var e = [],
                n = zv(t),
                r = n.extractWeights,
    ...
    function fg(t) { var e = new lg; return e.extractWeights(t), e }
    var pg, dg = (Pp(vg, pg = lg), vg);

    function vg() { return null !== pg && pg.apply(this, arguments) || this }
    var mg, gg = [new rd(.738768, .874946), new rd(2.42204, 2.65704), new rd(4.30971, 7.04493), new rd(10.246, 4.59428), new rd(12.6868, 11.8741)],
    ...
    var kg = (Object.defineProperty(Sg.prototype, "inputSize", { get: function() { return this._inputSize }, enumerable: !0, configurable: !0 }), Object.defineProperty(Sg.prototype, "scoreThreshold", { get: function() { return this._scoreThreshold }, enumerable: !0, configurable: !0 }), Sg);
    ...
    var Dg, Ag = (Pp(Tg, Dg = kv), Object.defineProperty(Tg.prototype, "config", { get: function() { return this._config }, enumerable: !0, configurable: !0 }), Object.defineProperty(Tg.prototype, "withClassScores", { get: function() { return this.config.withClassScores || 1 < this.config.classes.length }, enumerable: !0, configurable: !0 }), Object.defineProperty(Tg.prototype, "boxEncodingSize", { get: function() { return 5 + (this.withClassScores ? this.config.classes.length : 0) }, enumerable: !0, configurable: !0 }), Tg.prototype.runTinyYolov2 = function(t, e) { var n = Eg(t, e.conv0); return n = Eg(n = Gc(n, [2, 2], [2, 2], "same"), e.conv1), n = Eg(n = Gc(n, [2, 2], [2, 2], "same"), e.conv2), n = Eg(n = Gc(n, [2, 2], [2, 2], "same"), e.conv3), n = Eg(n = Gc(n, [2, 2], [2, 2], "same"), e.conv4), n = Eg(n = Gc(n, [2, 2], [2, 2], "same"), e.conv5), Nv(n = Eg(n = Eg(n = Gc(n, [2, 2], [1, 1], "same"), e.conv6), e.conv7), e.conv8, "valid", !1) }, Tg.prototype.runMobilenet = function(t, e) { var n = this.config.isFirstLayerConv2d ? Cg(Nv(t, e.conv0, "valid", !1)) : _g(t, e.conv0); return n = _g(n = Gc(n, [2, 2], [2, 2], "same"), e.conv1), n = _g(n = Gc(n, [2, 2], [2, 2], "same"), e.conv2), n = _g(n = Gc(n, [2, 2], [2, 2], "same"), e.conv3), n = _g(n = Gc(n, [2, 2], [2, 2], "same"), e.conv4), n = _g(n = Gc(n, [2, 2], [2, 2], "same"), e.conv5), n = Gc(n, [2, 2], [1, 1], "same"), n = e.conv6 ? _g(n, e.conv6) : n, Nv(n = e.conv7 ? _g(n, e.conv7) : n, e.conv8, "valid", !1) }, Tg.prototype.forwardInput = function(e, n) {
        var r = this,
            o = this.params;
        if (!o) throw new Error("TinyYolov2 - load model before inference");
        return nn(function() { var t = e.toBatchTensor(n, !1).toFloat(); return t = (t = r.config.meanRgb ? yd(t, r.config.meanRgb) : t).div(kn(256)), r.config.withSeparableConvs ? r.runMobilenet(t, o) : r.runTinyYolov2(t, o) })
        ...
        return void 0 === v && (v = {}), Lp(this, void 0, void 0, function() {
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 3:
                        return u = t.sent(), i.dispose(), a.dispose(), c = u.map(function(t) { return t.box }), l = u.map(function(t) { return t.score }), h = u.map(function(t) { return t.classScore }), f = u.map(function(t) { return p.config.classes[t.label] }), [2, gd(c.map(function(t) { return t.rescale(n) }), l, this.config.iouThreshold, !0).map(function(t) { return new ld(l[t], h[t], f[t], c[t], s) })]
                }
            })
        })
    }, Tg.prototype.getDefaultModelName = function() { return "" }, Tg.prototype.extractParamsFromWeigthMap = function(t) {
        return function(t, e) {
            var n, r = [],
                o = Rg(t, r),
    ...
    function Tg(t) { var e = Dg.call(this, "TinyYolov2") || this; return wg(t), e._config = t, e }
    var Ng, Fg = (Pp(Mg, Ng = Ag), Object.defineProperty(Mg.prototype, "withSeparableConvs", { get: function() { return this.config.withSeparableConvs }, enumerable: !0, configurable: !0 }), Object.defineProperty(Mg.prototype, "anchors", { get: function() { return this.config.anchors }, enumerable: !0, configurable: !0 }), Mg.prototype.locateFaces = function(e, n) {
        return Lp(this, void 0, void 0, function() {
            return Wp(this, function(t) {
                switch (t.label) {
                    case 0:
                    ...
                    case 1:
                        return [2, t.sent().map(function(t) { return new pd(t.score, t.relativeBox, { width: t.imageWidth, height: t.imageHeight }) })]
                }
            })
        })
    }, Mg.prototype.getDefaultModelName = function() { return this.withSeparableConvs ? "tiny_yolov2_separable_conv_model" : "tiny_yolov2_model" }, Mg.prototype.extractParamsFromWeigthMap = function(t) { return Ng.prototype.extractParamsFromWeigthMap.call(this, t) }, Mg);

    function Mg(t) { void 0 === t && (t = !0); var e = Object.assign({}, { withSeparableConvs: t, iouThreshold: .4, classes: ["face"] }, t ? { anchors: yg, meanRgb: xg } : { anchors: gg, withClassScores: !0 }); return Ng.call(this, e) || this }
    var Og, Pg = (Pp(Bg, Og = kg), Bg);

    function Bg() { var t = null !== Og && Og.apply(this, arguments) || this; return t._name = "TinyFaceDetectorOptions", t }
    ...
    }, Wg.prototype.run = function() { return Lp(this, void 0, void 0, function() { return Wp(this, function(t) { throw new Error("ComposableTask - run is not implemented") }) }) }, Wg);

    function Wg() {}

    function zg(a, s, u, c, l) {
        return void 0 === l && (l = function(t) { return t.alignedRect }), Lp(this, void 0, void 0, function() {
            var e, n, r, o, i;
            return Wp(this, function(t) {
                switch (t.label) {
                    case 0:
    ...
    function Ug(e, r, o, i, a) { return Lp(this, void 0, void 0, function() { var n = this; return Wp(this, function(t) { return [2, zg([e], r, function(e) { return Lp(n, void 0, void 0, function() { return Wp(this, function(t) { return [2, o(e[0])] }) }) }, i, a)] }) }) }
    var Vg = 2,
        Gg = 12;
    ...
    function Zg(s, t, u, c, l) {
        ...
        var e = t.map(function(a) {
                ...
                var e = t.scoresTensor,
                    ...
                    i = function(t, o, i, e) {
                        for (var n = [], a = t.arraySync(), r = 0; r < t.shape[0]; r++)
                            for (var s = 0; s < t.shape[1]; s++) a[r][s] >= e && n.push(new rd(s, r));
                ...
                var a = Date.now(),
                    s = gd(i.map(function(t) { return t.cell }), i.map(function(t) { return t.score }), .5);
                ...
                switch (t.label) {
                    ...
                    case 1:
                        return e = t.sent(), i = [], e.forEach(function(t) {
                            ...
                            i.push(r)
                        }), [2, i.map(function(t) { return nn(function() { return $g(gl(Tn(t, [1, a, s, 3]), [0, 2, 1, 3]).toFloat()) }) })]
                }
            })
        })
    }
                ...
                switch (t.label) {
                    ...
                    case 1:
                        return n = t.sent(), x.stage2_extractImagePatches = Date.now() - e, e = Date.now(), r = n.map(function(t) {
                            ...
                            return t.dispose(), e
                        }), x.stage2_rnet = Date.now() - e, o = 1 < r.length ? Vn(r.map(function(t) { return t.scores })) : r[0].scores, s = (a = Array).from, [4, o.data()];
                    case 2:
                ...
                switch (t.label) {
                    ...
                    case 1:
                        return n = t.sent(), b.stage3_extractImagePatches = Date.now() - e, e = Date.now(), i = n.map(function(t) {
                            ...
                            return t.dispose(), e
                        }), b.stage3_onet = Date.now() - e, r = 1 < i.length ? Vn(i.map(function(t) { return t.scores })) : i[0].scores, s = (a = Array).from, [4, r.data()];
                    case 2:
                        return o = s.apply(a, [t.sent()]), r.dispose(), u = o.map(function(t, e) { return { score: t, idx: e } }).filter(function(t) { return t.score > y }).map(function(t) { return t.idx }), c = u.map(function(t) { var e = i[t].regions.arraySync(); return new Xg(e[0][0], e[0][1], e[0][2], e[0][3]) }), l = u.map(function(t, e) { return g[t].calibrate(c[e]) }), h = u.map(function(t) { return o[t] }), f = [], p = [], d = [], 0 < l.length && (e = Date.now(), v = gd(l, h, .7, !1), b.stage3_nms = Date.now() - e, f = v.map(function(t) { return l[t] }), p = v.map(function(t) { return h[t] }), d = v.map(function(r, o) { return Array(5).fill(0).map(function(t, e) { var n = i[r].points.arraySync(); return new rd(n[0][e] * (f[o].width + 1) + f[o].left, n[0][e + 5] * (f[o].height + 1) + f[o].top) }) })), i.forEach(function(t) { t.regions.dispose(), t.scores.dispose(), t.points.dispose() }), [2, { boxes: f, scores: p, points: d }]
                }
            })
        })
    }
    var ry, oy = (Pp(iy, ry = kv), iy.prototype.load = function(e) { return Lp(this, void 0, void 0, function() { return Wp(this, function(t) { return console.warn("mtcnn is deprecated and will be removed soon"), [2, ry.prototype.load.call(this, e)] }) }) }, iy.prototype.loadFromDisk = function(e) { return Lp(this, void 0, void 0, function() { return Wp(this, function(t) { return console.warn("mtcnn is deprecated and will be removed soon"), [2, ry.prototype.loadFromDisk.call(this, e)] }) }) }, iy.prototype.forwardInput = function(C, E) {
        return void 0 === E && (E = {}), Lp(this, void 0, void 0, function() {
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 3:
                        return b = t.sent(), r.total_stage3 = Date.now() - g, w = b.boxes.map(function(e, t) { return sm(Hd({}, new pd(b.scores[t], new Cd(e.left / c, e.top / u, e.width / c, e.height / u), { height: u, width: c })), new kd(b.points[t].map(function(t) { return t.sub(new rd(e.left, e.top)).div(new rd(e.width, e.height)) }), { width: e.width, height: e.height })) }), [2, a({ results: w, stats: r })]
                }
            })
        })
    ...
    }, iy.prototype.getDefaultModelName = function() { return "mtcnn_model" }, iy.prototype.extractParamsFromWeigthMap = function(t) { return qg(t) }, iy.prototype.extractParams = function(t) { return Hg(t) }, iy);

    function iy() { return ry.call(this, "Mtcnn") || this }
    var ay, sy = [new rd(1.603231, 2.094468), new rd(6.041143, 7.080126), new rd(2.882459, 3.518061), new rd(4.266906, 5.178857), new rd(9.041765, 10.66308)],
        uy = [117.001, 114.697, 97.404],
        cy = (Pp(ly, ay = Ag), Object.defineProperty(ly.prototype, "anchors", { get: function() { return this.config.anchors }, enumerable: !0, configurable: !0 }), ly.prototype.locateFaces = function(e, n) {
            return Lp(this, void 0, void 0, function() {
                return Wp(this, function(t) {
                    switch (t.label) {
                        case 0:
        ...
        }, ly.prototype.getDefaultModelName = function() { return "tiny_face_detector_model" }, ly.prototype.extractParamsFromWeigthMap = function(t) { return ay.prototype.extractParamsFromWeigthMap.call(this, t) }, ly);
    ...
    function py(t) { return vy.ssdMobilenetv1.load(t) }
    var dy, vy = { ssdMobilenetv1: new lg, tinyFaceDetector: new cy, tinyYolov2: new Fg, mtcnn: new oy, faceLandmark68Net: new km, faceLandmark68TinyNet: new Fm, faceRecognitionNet: new jm, faceExpressionNet: new nm, ageGenderNet: new wm },
        my = py,
        gy = hy,
        yy = fy,
        xy = (Pp(by, dy = Lg), by);

    function by(t, e, n) { var r = dy.call(this) || this; return r.parentTask = t, r.input = e, r.extractedFaces = n, r }
        ...
        return Lp(this, void 0, void 0, function() {
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 2:
                        return n = t.sent(), [2, e.map(function(t, e) { return im(t, n[e]) })]
                }
            })
        })
    }, Ey.prototype.withAgeAndGender = function() { return new By(this, this.input) }, Ey);
    ...
    }, Ry.prototype.withAgeAndGender = function() { return new zy(this, this.input) }, Ry);

    function Ry() { return null !== _y && _y.apply(this, arguments) || this }
    var ky, Sy = (Pp(Dy, ky = Cy), Dy.prototype.withAgeAndGender = function() { return new Gy(this, this.input) }, Dy.prototype.withFaceDescriptors = function() { return new Qy(this, this.input) }, Dy);

    function Dy() { return null !== ky && ky.apply(this, arguments) || this }
    var Ay, Ty = (Pp(Ny, Ay = Iy), Ny.prototype.withAgeAndGender = function() { return new jy(this, this.input) }, Ny.prototype.withFaceDescriptor = function() { return new ex(this, this.input) }, Ny);

    function Ny() { return null !== Ay && Ay.apply(this, arguments) || this }
    var Fy, My = (Pp(Oy, Fy = Lg), Oy);

    function Oy(t, e, n) { var r = Fy.call(this) || this; return r.parentTask = t, r.input = e, r.extractedFaces = n, r }
    ...
    }, Ly.prototype.withFaceExpressions = function() { return new Cy(this, this.input) }, Ly);
    ...
    }, Uy.prototype.withFaceExpressions = function() { return new Iy(this, this.input) }, Uy);

    function Uy() { return null !== Wy && Wy.apply(this, arguments) || this }
    var Vy, Gy = (Pp(Hy, Vy = By), Hy.prototype.withFaceExpressions = function() { return new Sy(this, this.input) }, Hy.prototype.withFaceDescriptors = function() { return new Qy(this, this.input) }, Hy);

    function Hy() { return null !== Vy && Vy.apply(this, arguments) || this }
    var qy, jy = (Pp(Ky, qy = zy), Ky.prototype.withFaceExpressions = function() { return new Ty(this, this.input) }, Ky.prototype.withFaceDescriptor = function() { return new ex(this, this.input) }, Ky);

    function Ky() { return null !== qy && qy.apply(this, arguments) || this }
    var Xy, Yy = (Pp($y, Xy = Lg), $y);

    function $y(t, e) { var n = Xy.call(this) || this; return n.parentTask = t, n.input = e, n }
        ...
        return Lp(this, void 0, void 0, function() {
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 2:
                        return [2, t.sent().map(function(t, e) { return Xm(n[e], t) })]
                }
            })
        })
    }, Zy.prototype.withFaceExpressions = function() { return new Sy(this, this.input) }, Zy.prototype.withAgeAndGender = function() { return new Gy(this, this.input) }, Zy);
    ...
    }, nx.prototype.withFaceExpressions = function() { return new Ty(this, this.input) }, nx.prototype.withAgeAndGender = function() { return new jy(this, this.input) }, nx);

    function nx() { return null !== tx && tx.apply(this, arguments) || this }
    var rx, ox = (Pp(ix, rx = Lg), Object.defineProperty(ix.prototype, "landmarkNet", { get: function() { return this.useTinyLandmarkNet ? vy.faceLandmark68TinyNet : vy.faceLandmark68Net }, enumerable: !0, configurable: !0 }), ix);

    function ix(t, e, n) { var r = rx.call(this) || this; return r.parentTask = t, r.input = e, r.useTinyLandmarkNet = n, r }
        ...
        return Lp(this, void 0, void 0, function() {
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 6:
                        return i = t.sent(), r.forEach(function(t) { return t instanceof bt && t.dispose() }), [2, e.map(function(t, e) { return sm(t, i[e]) })]
                }
            })
        })
    }, ux.prototype.withFaceExpressions = function() { return new Sy(this, this.input) }, ux.prototype.withAgeAndGender = function() { return new Gy(this, this.input) }, ux.prototype.withFaceDescriptors = function() { return new Qy(this, this.input) }, ux);
        ...
        return Lp(this, void 0, void 0, function() {
            ...
            return Wp(this, function(t) {
                switch (t.label) {
                    ...
                    case 6:
                        return i = t.sent(), r.forEach(function(t) { return t instanceof bt && t.dispose() }), [2, sm(e, i)]
                }
            })
        })
    }, hx.prototype.withFaceExpressions = function() { return new Ty(this, this.input) }, hx.prototype.withAgeAndGender = function() { return new jy(this, this.input) }, hx.prototype.withFaceDescriptor = function() { return new ex(this, this.input) }, hx);

    function hx() { return null !== cx && cx.apply(this, arguments) || this }
    var fx, px = (Pp(dx, fx = Lg), dx);

    function dx(t, e) { void 0 === e && (e = new sg); var n = fx.call(this) || this; return n.input = t, n.options = e, n }
    ...
    var Ix = (Object.defineProperty(Rx.prototype, "labeledDescriptors", { get: function() { return this._labeledDescriptors }, enumerable: !0, configurable: !0 }), Object.defineProperty(Rx.prototype, "distanceThreshold", { get: function() { return this._distanceThreshold }, enumerable: !0, configurable: !0 }), Rx.prototype.computeMeanDistance = function(e, t) { return t.map(function(t) { return _x(t, e) }).reduce(function(t, e) { return t + e }, 0) / (t.length || 1) }, Rx.prototype.matchDescriptor = function(r) {
        var o = this;
    ...
    c.AgeGenderNet = wm, c.BoundingBox = ud, c.Box = id, c.ComposableTask = Lg, c.ComputeAllFaceDescriptorsTask = Qy, c.ComputeFaceDescriptorsTaskBase = Yy, c.ComputeSingleFaceDescriptorTask = ex, c.DetectAllFaceLandmarksTask = sx, c.DetectAllFacesTask = mx, c.DetectFaceLandmarksTaskBase = ox, c.DetectFacesTaskBase = px, c.DetectSingleFaceLandmarksTask = lx, c.DetectSingleFaceTask = xx, c.Dimensions = Up, c.FACE_EXPRESSION_LABELS = Qv, c.FaceDetection = pd, c.FaceDetectionNet = dg, c.FaceExpressionNet = nm, c.FaceExpressions = Zv, c.FaceLandmark68Net = km, c.FaceLandmark68TinyNet = Fm, c.FaceLandmarkNet = Pm, c.FaceLandmarks = _d, c.FaceLandmarks5 = kd, c.FaceLandmarks68 = Ad, c.FaceMatch = Nd, c.FaceMatcher = Ix, c.FaceRecognitionNet = jm, c.LabeledBox = Od, c.LabeledFaceDescriptors = Bd, c.Mtcnn = oy, c.MtcnnOptions = Jm, c.NetInput = yv, c.NeuralNetwork = kv, c.ObjectDetection = ld, c.Point = rd, c.PredictedBox = Ud, c.Rect = Cd, c.SsdMobilenetv1 = lg, c.SsdMobilenetv1Options = sg, c.TinyFaceDetector = cy, c.TinyFaceDetectorOptions = Pg, c.TinyYolov2 = Fg, c.TinyYolov2Options = kg, c.allFaces = Ex, c.allFacesMtcnn = function(e, n) {
        ...
        return e
    }, c.sigmoid = bd, c.ssdMobilenetv1 = hy, c.tf = Fp, c.tinyFaceDetector = function(t, e) { return vy.tinyFaceDetector.locateFaces(t, e) }, c.tinyYolov2 = function(t, e) { return vy.tinyYolov2.locateFaces(t, e) }, c.toNetInput = bv, c.utils = nd, c.validateConfig = wg, Object.defineProperty(c, "__esModule", { value: !0 })
});